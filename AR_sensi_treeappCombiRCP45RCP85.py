...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/AR"+"/AR_rcp45_baumartenempfehlungen.gpkg", layer="AR_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/AR"+"/AR_rcp45_baumartenbedeutungen.gpkg", layer="AR_rcp45_baumartenbedeutungen", driver="GPKG")
baumartenbedeutungenrcp85=gpd.read_file(projectspace+"/AR"+"/AR_rcp85_baumartenbedeutungen.gpkg", layer="AR_rcp85_baumartenbedeutungen", driver="GPKG")
...
combi.to_file(projectspace+"/AR"+"/AR_baumartenempfehlungen_combi.gpkg", layer="AR_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

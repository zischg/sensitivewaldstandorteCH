...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/ZH"+"/ZH_rcp45_baumartenempfehlungen.gpkg", layer="ZH_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/ZH"+"/ZH_rcp45_baumartenbedeutungen.gpkg", layer="ZH_rcp45_baumartenbedeutungen", driver="GPKG")
baumartenbedeutungenrcp85=gpd.read_file(projectspace+"/ZH"+"/ZH_rcp85_baumartenbedeutungen.gpkg", layer="ZH_rcp85_baumartenbedeutungen", driver="GPKG")
...
combi.to_file(projectspace+"/ZH"+"/ZH_baumartenempfehlungen_combi.gpkg", layer="ZH_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

...
treeapp=gpd.read_file(projectspace+"/SZ/stok_gdf_attributed.gpkg", layer='stok_gdf_attributed')
...
#treeapp.to_file(projectspace + '/SZ/stok_gdf_attributed.gpkg', layer='stok_gdf_attributed', driver="GPKG")
#checknonais=treeapp[treeapp['nais']=='']
#checknonais=treeapp[treeapp['nais']=='46(53Ta)']


treeapp.columns
treeapp=treeapp[['joinid', 'SZ Einheit', 'taheute', 'storeg','meanslopeprc', 'slpprzrec', 'rad', 'radiation', 'hs1975', 'nais','nais1', 'nais2', 'mo', 'ue', 'tahs', 'tahsue', 'geometry']]
...
for col in naismatrixdf.columns[8:].tolist():
    ...
    id+=1
joblib.dump(nais_matrix_standorte_list,projectspace+"/SZ/"+"nais_matrix_standorte_list.sav")
...
for climatescenario in climatescenarios:
    ...
    ccgdf=gpd.read_file(projectspace+"/SZ/SZ_vegetationshoehenstufen_"+climatescenario+".gpkg", layer='SZ_vegetationshoehenstufen_'+climatescenario)
    ccgdf.crs
    len(ccgdf)
    print("Overlay ...")
    ...
    combinations_df=combinations_df[['SZ Einheit', 'nais','nais1', 'nais2', 'mo', 'ue','hs1975','taheute','storeg', 'tahs','tahsue', 'meanslopeprc', 'slpprzrec', 'lage','rad', 'radiation', 'HS_de', 'Code', 'Subcode','geometry']]
    combinations_df.columns
    ...
    joblib.dump(combinations_df, projectspace+"/SZ/combinations_df"+climatescenario+".sav")
    combinations_df.columns
    ...
    ##correct SZ
    combinations_df.loc[((combinations_df['nais'] == "46(53Ta)") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "obermontan")&(combinations_df["meanslopeprc"]<=20)), "naiszuk1"] = "46"
    combinations_df.loc[((combinations_df['nais'] == "46(53Ta)") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "obermontan") & (combinations_df["meanslopeprc"] > 20)), "naiszuk1"] = "19"
    combinations_df.loc[((combinations_df['nais'] == "46(53Ta)") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "obermontan")), "naiszuk2"] = "53Ta"
    combinations_df.loc[((combinations_df['nais'] == "46(53Ta)") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "untermontan") & (combinations_df["meanslopeprc"] <= 20)), "naiszuk1"] = "8*"
    combinations_df.loc[((combinations_df['nais'] == "46(53Ta)") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "untermontan") & (combinations_df["meanslopeprc"] > 20)), "naiszuk1"] = "8d"
    combinations_df.loc[((combinations_df['nais'] == "46(53Ta)") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "62"
    combinations_df.loc[((combinations_df['nais'] == "46(53Ta)") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "submontan") & (combinations_df["meanslopeprc"] <= 20)), "naiszuk1"] = "7*"
    combinations_df.loc[((combinations_df['nais'] == "46(53Ta)") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "submontan") & (combinations_df["meanslopeprc"] > 20)), "naiszuk1"] = "6"
    combinations_df.loc[((combinations_df['nais'] == "46(53Ta)") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "62"
    ...
    # listofnopathcombinations
    nopathoutfile = open(projectspace + "/SZ/" + climatescenario.lower() + "_listofnopathcombinations.txt", "w")
    ...
    for item in listofnopathcombinations2:
        nopathoutfile.write(str(item[0]) + ";" + str(item[1]) + ";" + str(item[2]) + ";" + str(item[3]) + "\n")
    nopathoutfile.close()
    joblib.dump(combinations_df, projectspace + "/SZ" + "SZ_" + climatescenario + "_combinations_df_futureSTO.sav")
    combinations_df.to_file(projectspace + "/SZ/" + "SZ_" + climatescenario + "_zukuenftigestandorte.gpkg")
    ...
    joblib.dump(gr_treetypes_LFI, projectspace + "/SZ/" + "treetypes_LFI.sav")

    naismatrix_gr_df = naismatrixdf[naismatrixdf["Abkuerzung"].isin(gr_treetypes_LFI)]
    len(naismatrix_gr_df)
    joblib.dump(naismatrix_gr_df, projectspace + "/SZ/" + "naismatrix_gr_df.sav")
    ...
    joblib.dump(combinations_df_bedeutung,
                projectspace + "/SZ" + "/SZ_" + climatescenario.lower() + "_combinations_df_baumartenbedeutungen.sav")
    ...
    combinations_df_bedeutung.to_file(projectspace + "/SZ" + "/SZ_" + climatescenario + "_baumartenbedeutungen.gpkg",
                                      layer="SZ_" + climatescenario + "_baumartenbedeutungen", driver="GPKG")
    ...
    #combinations_df_bedeutung = gpd.read_file(projectspace + "/SZ" + "/SZ_" + climatescenario + "_baumartenbedeutungen.gpkg",layer="SZ_" + climatescenario + "_baumartenbedeutungen", driver="GPKG")
    ...
    # combinations_df_bedeutung = joblib.load(projectspace + "/SZ" + "/SZ_" + climatescenario.lower() + "_combinations_df_baumartenbedeutungen.sav")
        ...
        combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["ue"] == 1) & (
            combinations_df_baumartenempfehlung[col + "zukUE"].isin(["c"])) & (
                                                     ~combinations_df_baumartenempfehlung[col + "heuUE"].isin(
                                                         ["a", "b", "c"]))), col] = 5
    # Arve
    combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["nais1"].isin(arvenundlaerchen)) & (combinations_df_baumartenempfehlung["tahs"] == 'obersubalpin') & (combinations_df_baumartenempfehlung["hszukcor"] == 'hochmontan')), 'SZ_'] = 6
    ...
    joblib.dump(combinations_df_baumartenempfehlung,
                projectspace + "/SZ" + "/SZ_" + climatescenario.lower() + "_baumartenempfehlungen.sav")
    combinations_df_baumartenempfehlung.to_file(
        projectspace + "/SZ" + "/SZ_" + climatescenario + "_baumartenempfehlungen.gpkg",
        layer="SZ_" + climatescenario + "_baumartenempfehlungen", driver="GPKG")
    ...
    joblib.dump(combinations_df_senstivestandorte,
                projectspace + "/SZ" + "/SZ_" + climatescenario.lower() + "_sensitivestandorte.sav")
    combinations_df_senstivestandorte.to_file(
        projectspace + "/SZ" + "/SZ_" + climatescenario + "_sensitivestandorte.gpkg",
        layer="SZ_" + climatescenario + "_sensitivestandorte", driver="GPKG")

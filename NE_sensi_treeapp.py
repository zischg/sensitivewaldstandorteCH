...
treeapp=gpd.read_file(projectspace+"/NE/stok_gdf_attributed.gpkg", layer='stok_gdf_attributed')
#delete double polygons
len(treeapp)
treeapp= treeapp.drop_duplicates(subset='geometry', keep='first')
len(treeapp)
treeapp.to_file(projectspace+"/NE/stok_gdf_attributed_unique.gpkg", layer='stok_gdf_attributed')
...
for col in naismatrixdf.columns[8:].tolist():
    ...
    id+=1
joblib.dump(nais_matrix_standorte_list,projectspace+"/NE/"+"nais_matrix_standorte_list.sav")
...
for climatescenario in climatescenarios:
    ...
    ccgdf=gpd.read_file(projectspace+"/NE/vegetationshoehenstufen_"+climatescenario+".gpkg", layer='vegetationshoehenstufen_'+climatescenario)
    ccgdf.crs
    len(ccgdf)
    ...
    combinations_df=combinations_df[['code_neuch', 'associatio','nais', 'nais1', 'nais2', 'mo', 'ue','hs1975','taheute','storeg', 'tahs','tahsue', 'meanslopeprc', 'slpprzrec', 'lage','rad', 'radiation', 'HS_de', 'Code', 'Subcode','geometry']]
    combinations_df.columns
    ...
    joblib.dump(combinations_df, projectspace+"/NE/combinations_df"+climatescenario+".sav")
    combinations_df.columns
    ...
    #correct NE
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df["nais1"] == "29 ") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "29 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df["nais1"] == "29 ") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "29 collin"
    # ue
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df["nais2"] == "29 ") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "29 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df["nais2"] == "29 ") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "29 collin"
    ...
    # listofnopathcombinations
    nopathoutfile = open(projectspace + "/NE/" + climatescenario.lower() + "_listofnopathcombinations.txt", "w")
    ...
    for item in listofnopathcombinations2:
        nopathoutfile.write(str(item[0]) + ";" + str(item[1]) + ";" + str(item[2]) + ";" + str(item[3]) + "\n")
    nopathoutfile.close()
    joblib.dump(combinations_df, projectspace + "/NE" + "NE_" + climatescenario + "_combinations_df_futureSTO.sav")
    combinations_df.to_file(projectspace + "/NE/" + "NE_" + climatescenario + "_zukuenftigestandorte.gpkg")
    ...
    joblib.dump(gr_treetypes_LFI, projectspace + "/NE/" + "treetypes_LFI.sav")

    naismatrix_gr_df = naismatrixdf[naismatrixdf["Abkuerzung"].isin(gr_treetypes_LFI)]
    len(naismatrix_gr_df)
    joblib.dump(naismatrix_gr_df, projectspace + "/NE/" + "naismatrix_gr_df.sav")
    ...
    joblib.dump(combinations_df_bedeutung,
                projectspace + "/NE" + "/NE_" + climatescenario.lower() + "_combinations_df_baumartenbedeutungen.sav")
    ...
    combinations_df_bedeutung.to_file(projectspace + "/NE" + "/NE_" + climatescenario + "_baumartenbedeutungen.gpkg",
                                      layer="NE_" + climatescenario + "_baumartenbedeutungen", driver="GPKG")
    # sqlstatement='SELECT * NEOM public.grnaistahsstoregclip6190'+climatescenario+'_zukuenftigestandorte;'
        ...
        combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["ue"] == 1) & (
            combinations_df_baumartenempfehlung[col + "zukUE"].isin(["c"])) & (
                                                     ~combinations_df_baumartenempfehlung[col + "heuUE"].isin(
                                                         ["a", "b", "c"]))), col] = 5
    # Arve
    combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["nais1"].isin(arvenundlaerchen)) & (combinations_df_baumartenempfehlung["tahs"] == 'obersubalpin') & (combinations_df_baumartenempfehlung["hszukcor"] == 'hochmontan')), 'NE_'] = 6
    ...
    joblib.dump(combinations_df_baumartenempfehlung,
                projectspace + "/NE" + "/NE_" + climatescenario.lower() + "_baumartenempfehlungen.sav")
    combinations_df_baumartenempfehlung.to_file(
        projectspace + "/NE" + "/NE_" + climatescenario + "_baumartenempfehlungen.gpkg",
        layer="NE_" + climatescenario + "_baumartenempfehlungen", driver="GPKG")
    ...
    joblib.dump(combinations_df_senstivestandorte,
                projectspace + "/NE" + "/NE_" + climatescenario.lower() + "_sensitivestandorte.sav")
    # combinations_df_senstivestandorte.to_file(projectspace+"/NE"+"/NE_"+climatescenario+"_sensitivestandorte.shp")
    combinations_df_senstivestandorte.to_file(
        projectspace + "/NE" + "/NE_" + climatescenario + "_sensitivestandorte.gpkg",
        layer="NE_" + climatescenario + "_sensitivestandorte", driver="GPKG")
    combinations_df.columns
    # combinations_df.to_file(projectspace+"/NE/"+"NE_"+climatescenario+"_zukuenftigestandorte.shp")
    ...
    # combinations_df=joblib.load(projectspace+"/NE"+"/NE_"+climatescenario.lower()+"_zukuenftigestandorte.sav")
    # combinations_df_bedeutung.to_file(projectspace+"/"+"sg_"+climatescenario+"_baumartenbedeutungen.shp")
    ...
    # combinations_df_baumartenempfehlung.to_file(projectspace+"/NE/"+"NE_"+climatescenario+"_baumartenempfehlungen.shp")

...
#read excel files
naiseinheitenunique=pd.read_excel(codespace+"/JU_nais_einheiten_unique_v2_mf.xlsx", sheet_name='Sheet1', dtype="str", engine='openpyxl')
naiseinheitenunique.columns
naiseinheitenunique.dtypes
len(naiseinheitenunique)
naiseinheitenunique=naiseinheitenunique[['association', 'etiquette','BedingungHoehenstufe','nais1', 'nais2', 'hs']]
...
referenceraster=myworkspace+"/JU/JU_dem10m.tif"
...
sloperaster=myworkspace+"/JU/JU_slopeprz.tif"
radiationraster=myworkspace+"/JU/JU_globradyyw.tif"
hoehenstufenraster=myworkspace+"/JU/JU_vegetationshoehenstufen1975.tif"


#read shapefile
stok_gdf=gpd.read_file(myworkspace+'/JU/ENV_3_01_Phytosociologie_stations_forestieres/donnees.gpkg', layer='env.env_03_01_phytosociologie_stations_forestieres')
...
#del stok_gdfta
stok_gdf.columns
#stok_gdf=stok_gdf[['association','taheute','geometry']]
...
winsound.Beep(frequency, duration)
stok_gdf.columns
stok_gdf=stok_gdf[['association','etiquette','joinid', 'taheute', 'storeg','meanslopeprc', 'slpprzrec', 'rad', 'radiation', 'hs1975','geometry']]
stok_gdf.to_file(myworkspace+"/JU/stok_gdf_attributed_temp.gpkg")
#stok_gdf=gpd.read_file(myworkspace+"/JU/stok_gdf_attributed_temp.gpkg")
...
stok_gdf.loc[stok_gdf['association'].isnull()==True,'association']=''
stok_gdf.loc[stok_gdf['etiquette'].isnull()==True,'etiquette']=''
naiseinheitenunique.loc[naiseinheitenunique['association'].isnull()==True,'association']=''
naiseinheitenunique.loc[naiseinheitenunique['etiquette'].isnull()==True,'etiquette']=''
...
naiseinheitenunique.columns
bedingunghs=naiseinheitenunique[naiseinheitenunique['BedingungHoehenstufe'].isnull()==False]

stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38')&(stok_gdf['hs1975']<=4)), 'nais1'] = '39'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38')&(stok_gdf['hs1975']<=4)), 'hs'] = 'co sm'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38')&(stok_gdf['hs1975']>4)), 'nais1'] = '39*'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38')&(stok_gdf['hs1975']>4)), 'hs'] = 'um'

stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38 rocher')&(stok_gdf['hs1975']<=4)), 'nais1'] = '39'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38 rocher')&(stok_gdf['hs1975']<=4)), 'hs'] = 'co sm'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38 rocher')&(stok_gdf['hs1975']>4)), 'nais1'] = '39*'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38 rocher')&(stok_gdf['hs1975']>4)), 'hs'] = 'um'

stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38(14a)')&(stok_gdf['hs1975']<=4)), 'nais1'] = '39'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38(14a)')&(stok_gdf['hs1975']<=4)), 'nais2'] = '14'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38(14a)')&(stok_gdf['hs1975']<=4)), 'hs'] = 'sm'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38(14a)')&(stok_gdf['hs1975']>4)), 'nais1'] = '39*'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38(14a)')&(stok_gdf['hs1975']>4)), 'nais2'] = '14'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38(14a)')&(stok_gdf['hs1975']>4)), 'hs'] = 'um'

stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38(38w)')&(stok_gdf['hs1975']<=4)), 'nais1'] = '39'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38(38w)')&(stok_gdf['hs1975']<=4)), 'hs'] = 'co sm'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38(38w)')&(stok_gdf['hs1975']>4)), 'nais1'] = '39*'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38(38w)')&(stok_gdf['hs1975']>4)), 'hs'] = 'um'

stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38-38w rocher')&(stok_gdf['hs1975']<=4)), 'nais1'] = '39'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38-38w rocher')&(stok_gdf['hs1975']<=4)), 'hs'] = 'co sm'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38-38w rocher')&(stok_gdf['hs1975']>4)), 'nais1'] = '39*'
stok_gdf.loc[((stok_gdf['association']=='38')&(stok_gdf['etiquette']=='38-38w rocher')&(stok_gdf['hs1975']>4)), 'hs'] = 'um'

stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w')&(stok_gdf['hs1975']<=4)), 'nais1'] = '39'
stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w')&(stok_gdf['hs1975']<=4)), 'hs'] = 'co sm'
stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w')&(stok_gdf['hs1975']>4)), 'nais1'] = '39*'
stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w')&(stok_gdf['hs1975']>4)), 'hs'] = 'um'

stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w(14w)')&(stok_gdf['hs1975']<=4)), 'nais1'] = '39'
stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w(14w)')&(stok_gdf['hs1975']<=4)), 'nais2'] = '14'
stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w(14w)')&(stok_gdf['hs1975']<=4)), 'hs'] = 'sm'
stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w(14w)')&(stok_gdf['hs1975']>4)), 'nais1'] = '39*'
stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w(14w)')&(stok_gdf['hs1975']>4)), 'nais2'] = '14'
stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w(14w)')&(stok_gdf['hs1975']>4)), 'hs'] = 'um'

stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w(14w-16w)')&(stok_gdf['hs1975']<=4)), 'nais1'] = '39'
stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w(14w-16w)')&(stok_gdf['hs1975']<=4)), 'nais2'] = '14'
stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w(14w-16w)')&(stok_gdf['hs1975']<=4)), 'hs'] = 'sm'
stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w(14w-16w)')&(stok_gdf['hs1975']>4)), 'nais1'] = '39*'
stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w(14w-16w)')&(stok_gdf['hs1975']>4)), 'nais2'] = '14'
stok_gdf.loc[((stok_gdf['association']=='38w')&(stok_gdf['etiquette']=='38w(14w-16w)')&(stok_gdf['hs1975']>4)), 'hs'] = 'um'
...
print('loop')
len(naiseinheitenunique)
naiseinheitenunique=naiseinheitenunique[naiseinheitenunique['BedingungHoehenstufe'].isnull()==True]
len(naiseinheitenunique)
...
for index, row in naiseinheitenunique.iterrows():
    ...
    stok_gdf.loc[((stok_gdf["association"] == kantonseinheit) &(stok_gdf["etiquette"] == etiquette)), "nais1"] = nais1
    stok_gdf.loc[((stok_gdf["association"] == kantonseinheit) &(stok_gdf["etiquette"] == etiquette)), "nais2"] = nais2
    stok_gdf.loc[((stok_gdf["association"] == kantonseinheit)&(stok_gdf["etiquette"] == etiquette) ), "hs"] = hs
    #Uebergang
    if nais2 !='':
        stok_gdf.loc[((stok_gdf["association"] == kantonseinheit)&(stok_gdf["etiquette"] == etiquette) ), "ue"] = 1
    #Hohenstufenzuweisung
    if len(hslist)==1:
        stok_gdf.loc[((stok_gdf["association"] == kantonseinheit)&(stok_gdf["etiquette"] == etiquette) ), "tahs"] = hoehenstufendictabkuerzungen[hslist[0]]
    else:
        if "(" in row['hs']:
            stok_gdf.loc[((stok_gdf["association"] == kantonseinheit)&(stok_gdf["etiquette"] == etiquette) ), "tahs"] = hoehenstufendictabkuerzungen[hslist[0]]
            stok_gdf.loc[((stok_gdf["association"] == kantonseinheit)&(stok_gdf["etiquette"] == etiquette) ), "tahsue"] = hoehenstufendictabkuerzungen[hslist[1]]
        else:
            for index2, row2 in stok_gdf[((stok_gdf["association"] == kantonseinheit)&(stok_gdf["etiquette"] == etiquette) )].iterrows():
                if row2['hs1975']>0:
...
fehlendeuebersetzungen=checknohs[['association', 'etiquette','hs1975','nais1','nais2',"hs"]].drop_duplicates()
fehlendeuebersetzungen.to_excel(myworkspace+'/JU/'+'fehlendeHoehenstufen.xlsx')
fehlendeuebersetzungen['nais1'].unique().tolist()
stok_gdf.loc[((stok_gdf["nais1"] == '39') & (stok_gdf["tahs"] == '')), "tahs"] = 'submontan'
stok_gdf.loc[((stok_gdf["nais1"] == '39*') & (stok_gdf["tahs"] == '')), "tahs"] = 'untermontan'

#check empty values
checknohs=stok_gdf[stok_gdf["tahs"]==""][['association','hs1975','nais1','nais2',"hs"]]
print('Diese EInheiten haben keine Uebersetzung: '+str(checknohs['association'].unique().tolist()))
fehlendeuebersetzungen=checknohs[['association', 'hs1975','nais1','nais2',"hs"]].drop_duplicates()
fehlendeuebersetzungen.to_excel(myworkspace+'/JU/'+'fehlendeHoehenstufen.xlsx')
...
#stok_gdf=stok_gdf[['g1','association', 'stanrgert', 'joinid', 'taheute', 'storeg', 'meanslopeprc','slpprzrec', 'rad', 'radiation', 'hs1975', 'nais', 'nais1','nais2', 'mo', 'ue', 'hs', 'tahs', 'tahsue', 'geometry']]
#stok_gdf=gpd.read_file(myworkspace+"/ZH/stok_gdf_attributed.gpkg")
stok_gdf=stok_gdf[['association','joinid', 'taheute', 'storeg', 'meanslopeprc','slpprzrec', 'rad', 'radiation', 'hs1975', 'nais', 'nais1','nais2', 'mo', 'ue', 'hs', 'tahs', 'tahsue', 'geometry']]
stok_gdf['fid']=stok_gdf.index
stok_gdf['area']=stok_gdf.geometry.area
len(stok_gdf)
stok_gdf=stok_gdf[stok_gdf['area']>0]
stok_gdf.to_file(myworkspace+"/JU/stok_gdf_attributed.gpkg",layer='stok_gdf_attributed', driver="GPKG")
print("done")
...
treeapp=stok_gdf[['association', 'nais','nais1', 'nais2', 'mo', 'ue','tahs', 'tahsue','geometry']]
treeapp.to_file(myworkspace+"/JU/JU_treeapp.gpkg", layer='JU_treeapp', driver="GPKG")
treeapp.columns
print("done")

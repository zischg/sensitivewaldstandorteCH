...
treeapp=gpd.read_file(projectspace+"/SO/stok_gdf_attributed.gpkg", layer='stok_gdf_attributed')
...
treeapp.loc[treeapp['nais']=='16(12w )', 'nais']='16(12w)' #remove trailing space
treeapp.loc[treeapp['nais']=='27h(12w )', 'nais']='27h(12w)' #remove trailing space
treeapp.loc[treeapp['nais']=='39*(13e )', 'nais']='39*(13e)' #remove trailing space
treeapp.loc[treeapp['nais']=='6(8a )', 'nais']='6(8a)' #remove trailing space
treeapp.loc[treeapp['nais']=='7S(7a )', 'nais']='7S(7a)' #remove trailing space
treeapp.loc[treeapp['nais']=='7f(7a )', 'nais']='7f(7a)' #remove trailing space
treeapp.loc[treeapp['nais']=='7f(7g )', 'nais']='7f(7g)' #remove trailing space
treeapp.loc[treeapp['nais']=='7S(9a )', 'nais']='7S(9a)' #remove trailing space
len(treeapp)
treeapp=treeapp[treeapp['stantrung']!='98'] #remove the 98 standorttyp, which is not in the naismatrix
treeapp=treeapp[treeapp['stantrung']!='99']
treeapp=treeapp[treeapp['stantrung']!='101']
treeapp=treeapp[treeapp['stantrung']!='N']

treeapp.to_file(projectspace + '/SO/stok_gdf_attributed.gpkg', layer='stok_gdf_attributed', driver="GPKG")


treeapp.columns
treeapp=treeapp[['joinid', 'stantrung', 'taheute', 'storeg','meanslopeprc', 'slpprzrec', 'rad', 'radiation', 'hs1975', 'nais','nais1', 'nais2', 'mo', 'ue', 'tahs', 'tahsue', 'geometry']]
...
for col in naismatrixdf.columns[8:].tolist():
    ...
    id+=1
joblib.dump(nais_matrix_standorte_list,projectspace+"/SO/"+"nais_matrix_standorte_list.sav")
...
for climatescenario in climatescenarios:
    ...
    ccgdf=gpd.read_file(projectspace+"/SO/SO_vegetationshoehenstufen_"+climatescenario+".gpkg", layer='SO_vegetationshoehenstufen_'+climatescenario)
    ccgdf.crs
    len(ccgdf)
    print("Overlay ...")
    ...
    combinations_df=combinations_df[['stantrung', 'nais','nais1', 'nais2', 'mo', 'ue','hs1975','taheute','storeg', 'tahs','tahsue', 'meanslopeprc', 'slpprzrec', 'lage','rad', 'radiation', 'HS_de', 'Code', 'Subcode','geometry']]
    combinations_df.columns
    ...
    joblib.dump(combinations_df, projectspace+"/SO/combinations_df"+climatescenario+".sav")
    combinations_df.columns
    ...
    # correct SO
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2a']) == True) & (combinations_df['nais2'] == "10a") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "10a"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J','2a']) == True) & (combinations_df['nais2'] == "9a") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "9a"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2a']) == True) & (combinations_df['nais1'] == "65") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "65"
    ...
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['nais1'] == "8e") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '8e-kol'
    ...
    # listofnopathcombinations
    nopathoutfile = open(projectspace + "/SO/" + climatescenario.lower() + "_listofnopathcombinations.txt", "w")
    ...
    for item in listofnopathcombinations2:
        nopathoutfile.write(str(item[0]) + ";" + str(item[1]) + ";" + str(item[2]) + ";" + str(item[3]) + "\n")
    nopathoutfile.close()
    joblib.dump(combinations_df, projectspace + "/SO" + "SO_" + climatescenario + "_combinations_df_futureSTO.sav")
    combinations_df.to_file(projectspace + "/SO/" + "SO_" + climatescenario + "_zukuenftigestandorte.gpkg")
    ...
    joblib.dump(gr_treetypes_LFI, projectspace + "/SO/" + "treetypes_LFI.sav")

    naismatrix_gr_df = naismatrixdf[naismatrixdf["Abkuerzung"].isin(gr_treetypes_LFI)]
    len(naismatrix_gr_df)
    joblib.dump(naismatrix_gr_df, projectspace + "/SO/" + "naismatrix_gr_df.sav")
    ...
    joblib.dump(combinations_df_bedeutung,
                projectspace + "/SO" + "/SO_" + climatescenario.lower() + "_combinations_df_baumartenbedeutungen.sav")
    ...
    combinations_df_bedeutung.to_file(projectspace + "/SO" + "/SO_" + climatescenario + "_baumartenbedeutungen.gpkg",
                                      layer="SO_" + climatescenario + "_baumartenbedeutungen", driver="GPKG")
        ...
        combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["ue"] == 1) & (
            combinations_df_baumartenempfehlung[col + "zukUE"].isin(["c"])) & (
                                                     ~combinations_df_baumartenempfehlung[col + "heuUE"].isin(
                                                         ["a", "b", "c"]))), col] = 5
    # Arve
    combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["nais1"].isin(arvenundlaerchen)) & (combinations_df_baumartenempfehlung["tahs"] == 'obersubalpin') & (combinations_df_baumartenempfehlung["hszukcor"] == 'hochmontan')), 'SO_'] = 6
    ...
    joblib.dump(combinations_df_baumartenempfehlung,
                projectspace + "/SO" + "/SO_" + climatescenario.lower() + "_baumartenempfehlungen.sav")
    combinations_df_baumartenempfehlung.to_file(
        projectspace + "/SO" + "/SO_" + climatescenario + "_baumartenempfehlungen.gpkg",
        layer="SO_" + climatescenario + "_baumartenempfehlungen", driver="GPKG")
    ...
    joblib.dump(combinations_df_senstivestandorte,
                projectspace + "/SO" + "/SO_" + climatescenario.lower() + "_sensitivestandorte.sav")
    combinations_df_senstivestandorte.to_file(
        projectspace + "/SO" + "/SO_" + climatescenario + "_sensitivestandorte.gpkg",
        layer="SO_" + climatescenario + "_sensitivestandorte", driver="GPKG")
    combinations_df.columns

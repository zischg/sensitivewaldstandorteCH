...
rcp45=gpd.read_file(projectspace+"/UR"+"/UR_rcp45_zukuenftigestandorte.gpkg", layer="UR_rcp45_zukuenftigestandorte", driver="GPKG")
rcp85=gpd.read_file(projectspace+"/UR"+"/UR_rcp85_zukuenftigestandorte.gpkg", layer="UR_rcp85_zukuenftigestandorte", driver="GPKG")
rcp45.columns
...
combi.to_file(projectspace+"/UR"+"/UR_Projektionswege_combi.gpkg", layer="UR_Projektionswege_combi", driver="GPKG")

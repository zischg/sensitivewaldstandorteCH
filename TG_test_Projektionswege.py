...
rcp45=gpd.read_file(projectspace+"/TG"+"/TG_rcp45_zukuenftigestandorte.gpkg", layer="TG_rcp45_zukuenftigestandorte", driver="GPKG")
rcp85=gpd.read_file(projectspace+"/TG"+"/TG_rcp85_zukuenftigestandorte.gpkg", layer="TG_rcp85_zukuenftigestandorte", driver="GPKG")
rcp45.columns
...
combi.to_file(projectspace+"/TG"+"/TG_Projektionswege_combi.gpkg", layer="TG_Projektionswege_combi", driver="GPKG")
...
combi_unique.to_excel(projectspace+'/TG/'+"/TG_Projektionspfade_unique.xlsx")
...
areastatistics.to_excel(projectspace+'/TG/'+"/TG_Projektionspfade_unique_area.xlsx")
...
rcp45unique.to_excel(projectspace+'/TG/'+"/TG_Projektionspfade_unique_RCP45.xlsx")
...
areastatistics_rcp45.to_excel(projectspace+'/TG/'+"/TG_Projektionspfade_unique_area_RCP45.xlsx")
...
rcp85unique.to_excel(projectspace+'/TG/'+"/TG_Projektionspfade_unique_RCP85.xlsx")
...
areastatistics_rcp85.to_excel(projectspace+'/TG/'+"/TG_Projektionspfade_unique_area_RCP85.xlsx")
print('all done')

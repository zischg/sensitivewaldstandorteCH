...
treeapp=gpd.read_file(projectspace+"/ZG/stok_gdf_attributed.gpkg", layer='stok_gdf_attributed')
checkdoppelths=treeapp[((treeapp['tahsue']!='')&(treeapp['ue']==0))]
treeapp.loc[treeapp['ue']==0,'tahsue']=''
treeapp=treeapp[treeapp['nais1']!='t']
#treeapp.to_file(projectspace+"/ZG/stok_gdf_attributed.gpkg", layer='stok_gdf_attributed')
len(treeapp)
treeapp=treeapp[treeapp['nais1'].notnull()]
treeapp=treeapp[treeapp['nais1']!='']
treeapp.columns
treeapp=treeapp[['joinid', 'NUMMER', 'taheute', 'storeg','meanslopeprc', 'slpprzrec', 'rad', 'radiation', 'hs1975', 'nais','nais1', 'nais2', 'mo', 'ue', 'tahs', 'tahsue', 'geometry']]
...
for col in naismatrixdf.columns[8:].tolist():
    ...
    id+=1
joblib.dump(nais_matrix_standorte_list,projectspace+"/ZG/"+"nais_matrix_standorte_list.sav")
...
for climatescenario in climatescenarios:
    ...
    ccgdf=gpd.read_file(projectspace+"/ZG/ZG_vegetationshoehenstufen_"+climatescenario+".gpkg", layer='ZG_vegetationshoehenstufen_'+climatescenario)
    ccgdf.crs
    len(ccgdf)
    print("Overlay ...")
    ...
    combinations_df=combinations_df[['NUMMER', 'nais','nais1', 'nais2', 'mo', 'ue','hs1975','taheute','storeg', 'tahs','tahsue', 'meanslopeprc', 'slpprzrec', 'lage','rad', 'radiation', 'HS_de', 'Code', 'Subcode','geometry']]
    combinations_df.columns
    ...
    joblib.dump(combinations_df, projectspace+"/ZG/combinations_df"+climatescenario+".sav")
    combinations_df.columns
    ...
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M']) == True) & (combinations_df['nais1'] == "18w") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "17"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M']) == True) & (combinations_df['nais1'] == "31") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "31"
    #nais2
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M']) == True) & (combinations_df['nais2'] == "26h") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "26"
    ...
    # listofnopathcombinations
    nopathoutfile = open(projectspace + "/ZG/" + climatescenario.lower() + "_listofnopathcombinations.txt", "w")
    ...
    for item in listofnopathcombinations2:
        nopathoutfile.write(str(item[0]) + ";" + str(item[1]) + ";" + str(item[2]) + ";" + str(item[3]) + "\n")
    nopathoutfile.close()
    joblib.dump(combinations_df, projectspace + "/ZG" + "ZG_" + climatescenario + "_combinations_df_futureSTO.sav")
    combinations_df.to_file(projectspace + "/ZG/" + "ZG_" + climatescenario + "_zukuenftigestandorte.gpkg")
    ...
    joblib.dump(gr_treetypes_LFI, projectspace + "/ZG/" + "treetypes_LFI.sav")

    naismatrix_gr_df = naismatrixdf[naismatrixdf["Abkuerzung"].isin(gr_treetypes_LFI)]
    len(naismatrix_gr_df)
    joblib.dump(naismatrix_gr_df, projectspace + "/ZG/" + "naismatrix_gr_df.sav")
    ...
    joblib.dump(combinations_df_bedeutung,
                projectspace + "/ZG" + "/ZG_" + climatescenario.lower() + "_combinations_df_baumartenbedeutungen.sav")
    ...
    combinations_df_bedeutung.to_file(projectspace + "/ZG" + "/ZG_" + climatescenario + "_baumartenbedeutungen.gpkg",
                                      layer="ZG_" + climatescenario + "_baumartenbedeutungen", driver="GPKG")
        ...
        combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["ue"] == 1) & (
            combinations_df_baumartenempfehlung[col + "zukUE"].isin(["c"])) & (
                                                     ~combinations_df_baumartenempfehlung[col + "heuUE"].isin(
                                                         ["a", "b", "c"]))), col] = 5
    # Arve
    combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["nais1"].isin(arvenundlaerchen)) & (combinations_df_baumartenempfehlung["tahs"] == 'obersubalpin') & (combinations_df_baumartenempfehlung["hszukcor"] == 'hochmontan')), 'ZG_'] = 6
    ...
    joblib.dump(combinations_df_baumartenempfehlung,
                projectspace + "/ZG" + "/ZG_" + climatescenario.lower() + "_baumartenempfehlungen.sav")
    combinations_df_baumartenempfehlung.to_file(
        projectspace + "/ZG" + "/ZG_" + climatescenario + "_baumartenempfehlungen.gpkg",
        layer="ZG_" + climatescenario + "_baumartenempfehlungen", driver="GPKG")
    ...
    joblib.dump(combinations_df_senstivestandorte,
                projectspace + "/ZG" + "/ZG_" + climatescenario.lower() + "_sensitivestandorte.sav")
    combinations_df_senstivestandorte.to_file(
        projectspace + "/ZG" + "/ZG_" + climatescenario + "_sensitivestandorte.gpkg",
        layer="ZG_" + climatescenario + "_sensitivestandorte", driver="GPKG")
    combinations_df.columns

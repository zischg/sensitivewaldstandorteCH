...
treeapp=gpd.read_file(projectspace+"/UR/stok_gdf_attributed.gpkg", layer='stok_gdf_attributed')
treeapp.columns
treeapp=treeapp[['joinid', 'Kategorie_', 'taheute', 'storeg','meanslopeprc', 'slpprzrec', 'rad', 'radiation', 'hs1975', 'nais1', 'nais2', 'mo', 'ue', 'tahs', 'tahsue', 'geometry']]
#treeapp.rename(columns={'meanslopep':'meanslopeprc', 'nais_1':'nais'}, inplace=True)
treeapp.loc[treeapp['tahs'].isnull()==True,'tahs']='_'
treeapp.loc[treeapp['nais2'].isnull()==True,'nais2']=''
#treeapp.drop(columns='NAIS', inplace=True)
treeapp['nais']=''
treeapp.loc[treeapp['ue']==0,'nais']=treeapp['nais1']
treeapp.loc[treeapp['ue']==1,'nais']=treeapp['nais1']+'('+treeapp['nais2']+')'
treeapp['nais1'].unique().tolist()
len(treeapp)
treeapp=treeapp[treeapp['nais1'].isnull()==False]

#treeapp.to_file(projectspace+"/UR/stok_gdf_attributed.gpkg",layer='stok_gdf_attributed', driver="GPKG")
...
for col in naismatrixdf.columns[8:].tolist():
    ...
    id+=1
joblib.dump(nais_matrix_standorte_list,projectspace+"/UR/"+"nais_matrix_standorte_list.sav")
...
for climatescenario in climatescenarios:
    ...
    ccgdf=gpd.read_file(projectspace+"/UR/UR_vegetationshoehenstufen_"+climatescenario+".gpkg", layer='UR_vegetationshoehenstufen_'+climatescenario)
    ccgdf.crs
    len(ccgdf)
    print("Overlay ...")
    ...
    combinations_df=combinations_df[['Kategorie_', 'nais','nais1', 'nais2', 'mo', 'ue','hs1975','taheute','storeg', 'tahs','tahsue', 'meanslopeprc', 'slpprzrec', 'lage','rad', 'radiation', 'HS_de', 'Code', 'Subcode','geometry']]
    combinations_df.columns
    ...
    joblib.dump(combinations_df, projectspace+"/UR/combinations_df"+climatescenario+".sav")
    combinations_df.columns
    ...
    #correct UR, muss generell implementiert werden
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['nais1'] == "47") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = '3'
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']))&(combinations_df['nais'] == "50(60*Ta)") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = '7S'
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']))&(combinations_df['nais'] == "50(60*Ta)") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = '17'
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']))&(combinations_df['nais'] == "57V(60A)") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = '7*'
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']))&(combinations_df['nais'] == "57V(60A)") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = '7S'
    # Tannenhauptareal
    combinations_df.loc[((combinations_df['taheute'].isin([1,2]))&(combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) &(combinations_df['meanslopeprc']<=20)& (combinations_df['nais1'] == "49*") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = '27h'
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] <= 20) & (combinations_df['nais1'] == "49*") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = '27'
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] <= 20) & (combinations_df['nais1'] == "49*") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "usubmontan")), "naiszuk1"] = '27'
    combinations_df.loc[((combinations_df['taheute'].isin([1,2])) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) &(combinations_df['meanslopeprc']>20)& (combinations_df['nais1'] == "49*") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = '26h'
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] > 20) & (combinations_df['nais1'] == "49*") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = '26'
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] > 20) & (combinations_df['nais1'] == "49*") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = '26'
    #Tannenreliktareal
    combinations_df.loc[((combinations_df['taheute']==3) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] <= 20) & (combinations_df['nais1'] == "49*") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = '27h'
    combinations_df.loc[((combinations_df['taheute']==3) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] <= 20) & (combinations_df['nais1'] == "49*") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = '27'
    combinations_df.loc[((combinations_df['taheute']==3) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] <= 20) & (combinations_df['nais1'] == "49*") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "usubmontan")), "naiszuk1"] = '27'
    combinations_df.loc[((combinations_df['taheute']==3) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] > 20) & (combinations_df['nais1'] == "49*") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = '26h'
    combinations_df.loc[((combinations_df['taheute']==3) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] > 20) & (combinations_df['nais1'] == "49*") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = '26'
    combinations_df.loc[((combinations_df['taheute']==3) & (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] > 20) & (combinations_df['nais1'] == "49*") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = '26'
    ...
    # listofnopathcombinations
    nopathoutfile = open(projectspace + "/UR/" + climatescenario.lower() + "_listofnopathcombinations.txt", "w")
    ...
    for item in listofnopathcombinations2:
        nopathoutfile.write(str(item[0]) + ";" + str(item[1]) + ";" + str(item[2]) + ";" + str(item[3]) + "\n")
    nopathoutfile.close()
    joblib.dump(combinations_df, projectspace + "/UR" + "UR_" + climatescenario + "_combinations_df_futureSTO.sav")
    combinations_df.to_file(projectspace + "/UR/" + "UR_" + climatescenario + "_zukuenftigestandorte.gpkg")
    ...
    joblib.dump(gr_treetypes_LFI, projectspace + "/UR/" + "treetypes_LFI.sav")

    naismatrix_gr_df = naismatrixdf[naismatrixdf["Abkuerzung"].isin(gr_treetypes_LFI)]
    len(naismatrix_gr_df)
    joblib.dump(naismatrix_gr_df, projectspace + "/UR/" + "naismatrix_gr_df.sav")
    ...
    joblib.dump(combinations_df_bedeutung,
                projectspace + "/UR" + "/UR_" + climatescenario.lower() + "_combinations_df_baumartenbedeutungen.sav")
    ...
    combinations_df_bedeutung.to_file(projectspace + "/UR" + "/UR_" + climatescenario + "_baumartenbedeutungen.gpkg",
                                      layer="UR_" + climatescenario + "_baumartenbedeutungen", driver="GPKG")
        ...
        combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["ue"] == 1) & (
            combinations_df_baumartenempfehlung[col + "zukUE"].isin(["c"])) & (
                                                     ~combinations_df_baumartenempfehlung[col + "heuUE"].isin(
                                                         ["a", "b", "c"]))), col] = 5
    # Arve
    combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["nais1"].isin(arvenundlaerchen)) & (combinations_df_baumartenempfehlung["tahs"] == 'obersubalpin') & (combinations_df_baumartenempfehlung["hszukcor"] == 'hochmontan')), 'UR_'] = 6
    ...
    joblib.dump(combinations_df_baumartenempfehlung,
                projectspace + "/UR" + "/UR_" + climatescenario.lower() + "_baumartenempfehlungen.sav")
    combinations_df_baumartenempfehlung.to_file(
        projectspace + "/UR" + "/UR_" + climatescenario + "_baumartenempfehlungen.gpkg",
        layer="UR_" + climatescenario + "_baumartenempfehlungen", driver="GPKG")
    ...
    joblib.dump(combinations_df_senstivestandorte,
                projectspace + "/UR" + "/UR_" + climatescenario.lower() + "_sensitivestandorte.sav")
    combinations_df_senstivestandorte.to_file(
        projectspace + "/UR" + "/UR_" + climatescenario + "_sensitivestandorte.gpkg",
        layer="UR_" + climatescenario + "_sensitivestandorte", driver="GPKG")
    combinations_df.columns

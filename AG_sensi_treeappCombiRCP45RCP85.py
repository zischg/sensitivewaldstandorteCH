...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/AG"+"/AG_rcp45_baumartenempfehlungen.gpkg", layer="AG_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/AG"+"/AG_rcp45_baumartenbedeutungen.gpkg", layer="AG_rcp45_baumartenbedeutungen", driver="GPKG")
baumartenbedeutungenrcp85=gpd.read_file(projectspace+"/AG"+"/AG_rcp85_baumartenbedeutungen.gpkg", layer="AG_rcp85_baumartenbedeutungen", driver="GPKG")
...
'geometry' in colist
combi.to_file(projectspace+"/AG"+"/AG_baumartenempfehlungen_combi.gpkg", layer="AG_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

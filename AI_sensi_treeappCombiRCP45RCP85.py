...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/AI"+"/AI_rcp45_baumartenempfehlungen.gpkg", layer="AI_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/AI"+"/AI_rcp45_baumartenbedeutungen.gpkg", layer="AI_rcp45_baumartenbedeutungen", driver="GPKG")
...
combi.to_file(projectspace+"/AI"+"/AI_baumartenempfehlungen_combi.gpkg", layer="AI_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

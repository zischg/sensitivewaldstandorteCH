...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/SO"+"/SO_rcp45_baumartenempfehlungen.gpkg", layer="SO_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/SO"+"/SO_rcp45_baumartenbedeutungen.gpkg", layer="SO_rcp45_baumartenbedeutungen", driver="GPKG")
baumartenbedeutungenrcp85=gpd.read_file(projectspace+"/SO"+"/SO_rcp85_baumartenbedeutungen.gpkg", layer="SO_rcp85_baumartenbedeutungen", driver="GPKG")
...
combi.to_file(projectspace+"/SO"+"/SO_baumartenempfehlungen_combi.gpkg", layer="SO_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/UR"+"/UR_rcp45_baumartenempfehlungen.gpkg", layer="UR_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/UR"+"/UR_rcp45_baumartenbedeutungen.gpkg", layer="UR_rcp45_baumartenbedeutungen", driver="GPKG")
baumartenbedeutungenrcp85=gpd.read_file(projectspace+"/UR"+"/UR_rcp85_baumartenbedeutungen.gpkg", layer="UR_rcp85_baumartenbedeutungen", driver="GPKG")
...
combi.to_file(projectspace+"/UR"+"/UR_baumartenempfehlungen_combi.gpkg", layer="UR_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

...
rcp45=gpd.read_file(projectspace+"/JU"+"/JU_rcp45_zukuenftigestandorte.gpkg", layer="JU_rcp45_zukuenftigestandorte", driver="GPKG")
rcp85=gpd.read_file(projectspace+"/JU"+"/JU_rcp85_zukuenftigestandorte.gpkg", layer="JU_rcp85_zukuenftigestandorte", driver="GPKG")
rcp45.columns
...
combi.to_file(projectspace+"/JU"+"/JU_Projektionswege_combi.gpkg", layer="JU_Projektionswege_combi", driver="GPKG")
...
combi_unique.to_excel(projectspace+'/JU/'+"/JU_Projektionspfade_unique.xlsx")
...
areastatistics.to_excel(projectspace+'/JU/'+"/JU_Projektionspfade_unique_area.xlsx")
...
rcp45unique.to_excel(projectspace+'/JU/'+"/JU_Projektionspfade_unique_RCP45.xlsx")
...
areastatistics_rcp45.to_excel(projectspace+'/JU/'+"/JU_Projektionspfade_unique_area_RCP45.xlsx")
...
rcp85unique.to_excel(projectspace+'/JU/'+"/JU_Projektionspfade_unique_RCP85.xlsx")
...
areastatistics_rcp85.to_excel(projectspace+'/JU/'+"/JU_Projektionspfade_unique_area_RCP85.xlsx")
print('all done')

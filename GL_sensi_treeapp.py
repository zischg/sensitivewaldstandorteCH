...
for index, row in nopaths2[["storegco",'nais2',"tahsue","hszukcor"]].iterrows():
    if row['nais2']!= "_" and [row["storegco"],row['nais2'], row["tahsue"], row["hszukcor"]] not in listofnopathcombinations2:
...
for standorttyp in naisstandortstypeninmatrixlist:
    ...
    for baumart in gr_treetypes_LFI:
        ...
        if baumartbedeutung in ["a", "b","c"]:
            combinations_df_bedeutung.loc[combinations_df_bedeutung[combinations_df_bedeutung['nais1']==standorttyp].index, baumart + "heu1"] = baumartbedeutung
            combinations_df_bedeutung.loc[combinations_df_bedeutung[combinations_df_bedeutung['nais2'] == standorttyp].index, baumart + "heu2"] = baumartbedeutung
...
joblib.dump(combinations_df_bedeutung, projectspace+"/GL"+"/GL_"+climatescenario.lower()+"_combinations_df_baumartenbedeutungen.sav")
...
combinations_df_bedeutung.to_file(projectspace+"/GL"+"/GL_"+climatescenario+"_baumartenbedeutungen.gpkg", layer="GL_"+climatescenario+"_baumartenbedeutungen", driver="GPKG")
...
joblib.dump(combinations_df_baumartenempfehlung, projectspace+"/GL"+"/GL_"+climatescenario.lower()+"_baumartenempfehlungen.sav")
combinations_df_baumartenempfehlung.to_file(projectspace+"/GL"+"/GL_"+climatescenario+"_baumartenempfehlungen.gpkg", layer="GL_"+climatescenario+"_baumartenempfehlungen", driver="GPKG")
...
joblib.dump(combinations_df_senstivestandorte, projectspace+"/GL"+"/GL_"+climatescenario.lower()+"_sensitivestandorte.sav")
#combinations_df_senstivestandorte.to_file(projectspace+"/GL"+"/GL_"+climatescenario+"_sensitivestandorte.shp")
combinations_df_senstivestandorte.to_file(projectspace+"/GL"+"/GL_"+climatescenario+"_sensitivestandorte.gpkg", layer="GL_"+climatescenario+"_sensitivestandorte", driver="GPKG")
combinations_df.columns
...
bk_gdf.dtypes
#bk_gdf["bkES"]=bk_gdf["ESAH"]
#bk_gdf["ESCODE"]=bk_gdf["ESAHCODE"]
#bk_gdf["bkBAH"]=bk_gdf["ESAH"]
#bk_gdf["BAHCODE"]=bk_gdf["ESAHCODE"]
#bk_gdf.rename(columns={"FI":"bkFI","TA":"bkTA","FOE":"bkWFO","FOECODE":"WFOCODE","BU":"bkBU",}, inplace=True)
len(bk_gdf)
#bk_gdf=bk_gdf[bk_gdf["bkFI"]!="keine Angabe"]
#bk_gdf=bk_gdf[bk_gdf["bkFI"]!="nicht interpretierbar"]
#bk_gdf=bk_gdf[bk_gdf["bkTA"]!="keine Angabe"]
#bk_gdf=bk_gdf[bk_gdf["bkTA"]!="nicht interpretierbar"]
#bk_gdf=bk_gdf[bk_gdf["bkWFO"]!="keine Angabe"]
#bk_gdf=bk_gdf[bk_gdf["bkWFO"]!="nicht interpretierbar"]
#bk_gdf=bk_gdf[bk_gdf["bkES"]!="keine Angabe"]
#bk_gdf=bk_gdf[bk_gdf["bkES"]!="nicht interpretierbar"]
#bk_gdf=bk_gdf[bk_gdf["bkBU"]!="keine Angabe"]
#bk_gdf=bk_gdf[bk_gdf["bkBU"]!="nicht interpretierbar"]
#bk_gdf=bk_gdf[bk_gdf["DG"]!="keine Angabe"]
#bk_gdf=bk_gdf[bk_gdf["DG"]!="nicht interpretierbar"]
rcp_baumartenempfehlungen_gdf_in=combinations_df_baumartenempfehlung.copy()
...
#rcp_baumartenempfehlungen_gdf_in.rename(columns={"TA_1":"TA"}, inplace=True)
rcp_baumartenempfehlungen_gdf_in.columns
...
#rcp_bk_gdf_in.reset_index(level=None, drop=False, inplace=True, col_level=0, col_fill='')
#rcp_bk_gdf_in.index.name = 'index'
#del rcp_baumartenempfehlungen_gdf_in
#rcp_bk_gdf_in.to_file(projectspace+"/GL/"+"GL_"+climatescenario+"_baumartenempfehlungen_intsct_bk.shp")
...
for col in treetypes:#_in_bk_list:
    ...
    if col in mainlayercolumnslist:
        rcp_bk_gdf_out["sb" + col] = -999
        rcp_bk_gdf_out.loc[rcp_bk_gdf_out[((rcp_bk_gdf_out["nhd_anteil"] >95)&(rcp_bk_gdf_out[col].isin([1,4])))].index, "sb"+col]=1
        rcp_bk_gdf_out.loc[rcp_bk_gdf_out[((rcp_bk_gdf_out["nhd_anteil"] > 0)&(rcp_bk_gdf_out["nhd_anteil"] <= 95) & (rcp_bk_gdf_out[col].isin([1, 4])))].index, "sb" + col] = 0
        rcp_bk_gdf_out.loc[rcp_bk_gdf_out[((rcp_bk_gdf_out["nhd_anteil"] > 95) & (rcp_bk_gdf_out[col].isin([2, 5])))].index, "sb" + col] = 3
        rcp_bk_gdf_out.loc[rcp_bk_gdf_out[((rcp_bk_gdf_out["nhd_anteil"] >= 70) & (rcp_bk_gdf_out["nhd_anteil"] <= 95) & (rcp_bk_gdf_out[col].isin([2, 5])))].index, "sb" + col] = 2
        rcp_bk_gdf_out.loc[rcp_bk_gdf_out[((rcp_bk_gdf_out["nhd_anteil"] >20) & (rcp_bk_gdf_out["nhd_anteil"] <70) & (rcp_bk_gdf_out[col].isin([2, 5])))].index, "sb" + col] = 1
        rcp_bk_gdf_out.loc[rcp_bk_gdf_out[((rcp_bk_gdf_out["nhd_anteil"] >0) & (rcp_bk_gdf_out["nhd_anteil"] <=20) & (rcp_bk_gdf_out[col].isin([2, 5])))].index, "sb" + col] = 0
        rcp_bk_gdf_out.loc[rcp_bk_gdf_out[((rcp_bk_gdf_out["nhd_anteil"] > 40) & (rcp_bk_gdf_out[col].isin([3])))].index, "sb" + col] = 3
        rcp_bk_gdf_out.loc[rcp_bk_gdf_out[((rcp_bk_gdf_out["nhd_anteil"] >20) & (rcp_bk_gdf_out["nhd_anteil"] <= 40) & (rcp_bk_gdf_out[col].isin([3])))].index, "sb" + col] = 2
        rcp_bk_gdf_out.loc[rcp_bk_gdf_out[((rcp_bk_gdf_out["nhd_anteil"] >10) & (rcp_bk_gdf_out["nhd_anteil"] <=20) & (rcp_bk_gdf_out[col].isin([3])))].index, "sb" + col] = 1
        rcp_bk_gdf_out.loc[rcp_bk_gdf_out[((rcp_bk_gdf_out["nhd_anteil"] >0) & (rcp_bk_gdf_out["nhd_anteil"] <= 10) & (rcp_bk_gdf_out[col].isin([3])))].index, "sb" + col] = 0
...
rcp_bk_gdf_out.to_file(projectspace+"/GL/"+"GL_"+climatescenario+"_sensitivebestaende.gpkg")
#del rcp_bk_gdf_in
...
bk_gdf.to_file(projectspace+"/GL/"+"GL_"+climatescenario+"_bk_maxsensitivitaet.gpkg")

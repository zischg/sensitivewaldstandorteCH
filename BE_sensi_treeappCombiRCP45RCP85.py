...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/BE"+"/BE_rcp45_baumartenempfehlungen.gpkg", layer="BE_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/BE"+"/BE_rcp45_baumartenbedeutungen.gpkg", layer="BE_rcp45_baumartenbedeutungen", driver="GPKG")
baumartenbedeutungenrcp85=gpd.read_file(projectspace+"/BE"+"/BE_rcp85_baumartenbedeutungen.gpkg", layer="BE_rcp85_baumartenbedeutungen", driver="GPKG")
...
combi.to_file(projectspace+"/BE"+"/BE_baumartenempfehlungen_combi.gpkg", layer="BE_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

...
def give_standortregionencombi_from_projektionspfade(in_Standortregion):
    if in_Standortregion in [1,2,3,"1","J","M","2","2a","2b","2c","3"]:# and in_hoehenstufe != "collin":
        out_combi="R, J, M, 1, 2, 3"
    #elif in_Standortregion in ["1","J","M","2","2a","2b","3"]:# and in_hoehenstufe == "collin":
        #out_combi = "R J, M,1, 2 Beginn co "
    elif in_Standortregion in [4,"4","4a","4b"]:
        out_combi = "R 4"
    elif in_Standortregion in [5,"5","5a","5b"]:
        out_combi = "R 5"
...
projectionswegedf.columns
projectionswegedf['Hoehenstufe_heute'].unique().tolist()
projectionswegedf['Hoehenstufe_Zukunft'].unique().tolist()
#treeapp=gpd.read_file(projectspace+"/GR/stok_gdf_attributed.gpkg", layer='stok_gdf_attributed')
#treeapp.columns
#treeapp=treeapp[['joinid', 'taheute', 'storeg','meanslopeprc', 'slpprzrec', 'rad', 'radiation', 'hs1975', 'nais','nais1', 'nais2', 'mo', 'ue', 'tahs', 'tahsue', 'geometry']]
...
for col in naismatrixdf.columns[8:].tolist():
    ...
    id+=1
joblib.dump(nais_matrix_standorte_list,projectspace+"/GR/"+"nais_matrix_standorte_list.sav")
...
for climatescenario in climatescenarios:
    ...
    #ccgdf=gpd.read_file(projectspace+"/GR/GR_vegetationshoehenstufen_"+climatescenario+".gpkg", layer='GR_vegetationshoehenstufen_'+climatescenario)
    #ccgdf.crs
    #len(ccgdf)
    print("Overlay ...")
    #combinations_df=treeapp.overlay(ccgdf, how='intersection')
    combinations_df = gpd.read_file(projectspace+"/GR/stok_gdf_attributed_"+climatescenario+".gpkg", layer='stok_gdf_attributed_'+climatescenario)
    combinations_df = combinations_df[combinations_df['nais1'].isnull() == False]
    combinations_df.loc[combinations_df['storeg'] == '2c', 'storeg'] = '2b'  # solange die alten Projektionswege gueltig sind, wird die neue Standortregionenkarte zurueckuebersetzt
    combinations_df.loc[combinations_df['storeg'] == '4a', 'storeg'] = '4'  # solange die alten Projektionswege gueltig sind, wird die neue Standortregionenkarte zurueckuebersetzt
    combinations_df.loc[combinations_df['storeg'] == '4b', 'storeg'] = '4'  # solange die alten Projektionswege gueltig sind, wird die neue Standortregionenkarte zurueckuebersetzt
    combinations_df.loc[combinations_df['nais1'] == '67/67G', 'ue'] = 1
    combinations_df.loc[combinations_df['nais1'] == '67/67G', 'mo'] = 1
    combinations_df.loc[combinations_df['nais1'] == '67/67G', 'nais2'] = '67G'
    combinations_df.loc[combinations_df['nais1'] == '67/67G', 'nais1'] = '67'
    combinations_df.loc[combinations_df['nais1'] == '69/69G', 'ue'] = 1
    combinations_df.loc[combinations_df['nais1'] == '69/69G', 'mo'] = 1
    combinations_df.loc[combinations_df['nais1'] == '69/69G', 'nais2'] = '69G'
    combinations_df.loc[combinations_df['nais1'] == '69/69G', 'nais1'] = '69'
    combinations_df.loc[combinations_df['nais1'] == '70/70G', 'ue'] = 1
    combinations_df.loc[combinations_df['nais1'] == '70/70G', 'mo'] = 1
    combinations_df.loc[combinations_df['nais1'] == '70/70G', 'nais2'] = '70G'
    combinations_df.loc[combinations_df['nais1'] == '70/70G', 'nais1'] = '70'
    combinations_df.loc[combinations_df['nais1'] == '71/71G', 'ue'] = 1
    combinations_df.loc[combinations_df['nais1'] == '71/71G', 'mo'] = 1
    combinations_df.loc[combinations_df['nais1'] == '71/71G', 'nais2'] = '71G'
    combinations_df.loc[combinations_df['nais1'] == '71/71G', 'nais1'] = '71'
    combinations_df.loc[combinations_df['storeg'] == '4a', 'storegco'] = 'R 4'
    combinations_df.loc[combinations_df['storeg'] == '4b', 'storegco'] = 'R 4'
    combinations_df.loc[combinations_df['storeg'] == '4', 'storegco'] = 'R 4'
    combinations_df.loc[combinations_df['storeg'] == '5a', 'storegco'] = 'R 5'
    combinations_df.loc[combinations_df['storeg'] == '3', 'storegco'] = 'R, J, M, 1, 2, 3'
    combinations_df.loc[combinations_df['storeg'] == ' 3', 'storegco'] = 'R, J, M, 1, 2, 3'
    combinations_df.loc[combinations_df['storeg'] == '2a', 'storegco'] = 'R, J, M, 1, 2, 3'
    combinations_df.loc[combinations_df['storeg'] == '2b', 'storegco'] = 'R, J, M, 1, 2, 3'
    combinations_df.loc[combinations_df['storeg'] == '1', 'storegco'] = 'R, J, M, 1, 2, 3'
    combinations_df.loc[combinations_df['storeg'] == ' 4a', 'storegco'] = 'R 4'
    combinations_df.loc[combinations_df['storeg'] == ' 4a', 'storeg'] = '4a'
    combinations_df.loc[combinations_df['storeg'] == ' 4b', 'storegco'] = 'R 4'
    combinations_df.loc[combinations_df['storeg'] == ' 4b', 'storeg'] = '4b'
    combinations_df.loc[combinations_df['storeg'] == ' 3', 'storeg'] = '3'
    combinations_df.loc[combinations_df['nais'].isin(['71/71G','67/67G','70/70G']), 'tahsue'] = combinations_df['tahs']
    combinations_df[combinations_df['storegco']=='R 5']['storeg'].unique().tolist()
    combinations_df[combinations_df['storegco'] == 'R 4']['storeg'].unique().tolist()
    combinations_df[combinations_df['storegco'] == 'R, J, M, 1, 2, 3']['storeg'].unique().tolist()
    combinations_df.columns
    combinations_df['tahs'].unique().tolist()
    combinations_df['tahsue'].unique().tolist()
    combinations_df['storeg'].unique().tolist()
    combinations_df['storegco'].unique().tolist()
    #correct 'unter-/obermontan' --> 'unter- & obermontan'
    combinations_df.loc[combinations_df['tahs'] == 'unter-/obermontan', 'tahs'] = 'unter- & obermontan'
    combinations_df.loc[combinations_df['tahsue'] == 'unter-/obermontan', 'tahsue'] = 'unter- & obermontan'

    print('Folgende STandortregionen sind vertreten: ' + str(combinations_df['storeg'].unique().tolist()))
    # treeapp.rename(columns={'meanslopep':'meanslopeprc', 'nais_1':'nais'}, inplace=True)
    combinations_df.loc[combinations_df['tahs'].isnull() == True, 'tahs'] = ''
    combinations_df.loc[combinations_df['nais2'].isnull() == True, 'nais2'] = ''
    ...
    len(combinations_df)
    combinations_df.columns
    combinations_df=combinations_df[['nais','nais1', 'nais2', 'mo', 'ue','hs1975','taheute','storeg', 'tahs','tahsue', 'meanslopeprc', 'slpprzrec', 'lage','rad', 'radiation', 'HS_de', 'Code', 'Subcode','geometry']]
    combinations_df.columns
    ...
    #correct VS
    checkstoreg=combinations_df[combinations_df['storegco']=='R 5']
    combinations_df.loc[((combinations_df["storegco"] == "R 4")&(combinations_df["storeg"]=="2b")), "storegco"] = 'R, J, M, 1, 2, 3'
    ...
    joblib.dump(combinations_df, projectspace+"/GR/combinations_df"+climatescenario+".sav")
    combinations_df.columns
    ...
    # correct VS
    naistypennotinprojektionswegedf=combinations_df[combinations_df['nais1'].isin(standortstypen_projektionspfade_heute_list)==False]
    naistypennotinprojektionswegelist=naistypennotinprojektionswegedf['nais1'].unique().tolist()
    combinations_df.loc[((combinations_df['storeg'].isin([1,'1',2, '2','2a','M']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "40PBl collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M','3']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "34*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M','3']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "subalpin")), "naiszuk1"] = "40PBl collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M','2b', '3']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = '40PBl'
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "40PBl collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M']) == True) & (combinations_df['nais1'] == "65*") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais1'] == "65*") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "65* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M']) == True) & (combinations_df['nais1'] == "65*") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais1'] == "65*") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "65* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df['nais1'] == "65*") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "38"
    combinations_df.loc[((combinations_df['storeg'].isin([1,'1',2,'2','2a','2b', '3']) == True) & (combinations_df['nais1'] == "65*") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "40*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais1'] == "65*") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "40*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', '3']) == True) & (combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "34*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', '3']) == True) & (combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', '3']) == True) & (combinations_df['nais1'] == "65") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "38 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['J','M']) == True) & (combinations_df['nais1'] == "65*") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "38"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '3']) == True) & (combinations_df['nais1'] == "65*") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "40*"

    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a','2b','3','M']) == True) & (combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a','2b','3','M']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "34*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a','2b','3','M']) == True)&(combinations_df['taheute'].isin([1,2])) & (combinations_df['nais1'] == "57VMTa") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "8a"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M']) == True) & (combinations_df['taheute'].isin([1, 2])) & (combinations_df['nais1'] == "57VMTa") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "7a"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df['nais1'] == "67") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "38"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais1'] == "67") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "40*"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df['nais1'] == "67") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "38"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais1'] == "67") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "40*"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df['nais1'] == "67") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais1'] == "67") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M','J']) == True) & (combinations_df['nais1'] == "29C") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "29C collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais1'] == "67G") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "40*"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df['nais1'] == "67G") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "38"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df['nais1'] == "67G") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais1'] == "67G") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais1'] == "57VMTa") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "51 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais1'] == "29A") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "29A collin"
    #combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais1'] == "57VMLä") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "51 collin"
    #combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais1'] == "57VMLä") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = "51"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais1'] == "52ReG") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "52 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "68 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "68 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = "68"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', 'J']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "41* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', 'J','2b', '3']) == True) & (combinations_df['nais1'] == "34*") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', 'J', '2b', '3']) == True) & (combinations_df['nais1'] == "25e") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25e collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "40PBl collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais1'] == "67") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais1'] == "58CG") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = "55*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais1'] == "58CG") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "55* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "40Pt") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "40P collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais1'] == "28") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "28 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "34*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais1'] == "30") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "30 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais1'] == "62") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "62 collin"

    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais1'] == "67G") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais1'] == "60G") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "50 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) &(combinations_df['taheute'].isin([1,2])) & (combinations_df['nais1'] == "60G") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = "50"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais1'] == "60G") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = "50Re"

    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais1'] == "32*G") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "26"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais1'] == "58L") & (combinations_df["tahs"] == "obersubalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = "55*"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais1'] == "58L") & (combinations_df["tahs"] == "obersubalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "55* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais1'] == "32*") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "26"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M', '1', '2a', '2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais1'] == "61") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "61 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais1'] == "53") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "62"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais1'] == "53") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "53* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais1'] == "53") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "62"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais1'] == "53") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "53* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais1'] == "68*") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "68* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais1'] == "68*") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "68* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', 'J', '2b', '3']) == True) & (combinations_df['nais1'] == "25e") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25e collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df['nais1'] == "26h") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = "26"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df['nais1'] == "26h") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "26h"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3'])) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "68 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3'])) & (combinations_df['nais1'] == "24") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "24 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3'])) & (combinations_df['nais1'] == "24") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = "24"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3'])) & (combinations_df['nais1'] == "59E") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = "53*"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3'])) & (combinations_df['nais1'] == "65*") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "65* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', 'J', '2b', '3'])) & (combinations_df['nais1'] == "44") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "44 collin"

    #ue
    naistypennotinprojektionswegedf = combinations_df[combinations_df['nais2'].isin(standortstypen_projektionspfade_heute_list) == False]
    naistypennotinprojektionswegelist = naistypennotinprojektionswegedf['nais2'].unique().tolist()
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M']) == True) & (combinations_df['nais2'] == "40PBl") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais2'] == "40PBl") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "40PBl collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', '3']) == True) & (combinations_df['nais2'] == "40PBl") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "34*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', '3']) == True) & (combinations_df['nais2'] == "40PBl") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais2'] == "40PBl") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "subalpin")), "naiszuk2"] = "40PBl collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', '2b', '3']) == True) & (combinations_df['nais2'] == "40PBl") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk2"] = '40PBl'
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M']) == True) & (combinations_df['nais2'] == "40PBl") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais2'] == "40PBl") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "40PBl collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M']) == True) & (combinations_df['nais2'] == "65*") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais2'] == "65*") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "65* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M']) == True) & (combinations_df['nais2'] == "65*") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais2'] == "65*") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "65* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df['nais2'] == "65*") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "38"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais2'] == "65*") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "40*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais2'] == "65*") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "40*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', '3']) == True) & (combinations_df['nais2'] == "47H") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "34*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', '3']) == True) & (combinations_df['nais2'] == "47H") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', '3']) == True) & (combinations_df['nais2'] == "65") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "38 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df['nais2'] == "65*") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "38"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '3']) == True) & (combinations_df['nais2'] == "65*") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "40*"

    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M']) == True) & (combinations_df['nais2'] == "47H") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M']) == True) & (combinations_df['nais2'] == "40PBl") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "34*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M']) == True) & (combinations_df['taheute'].isin([1, 2])) & (combinations_df['nais2'] == "57VMTa") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "8a"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M']) == True) & (combinations_df['taheute'].isin([1, 2])) & (combinations_df['nais2'] == "57VMTa") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "7a"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df['nais2'] == "67") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "38"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais2'] == "67") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "40*"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df['nais2'] == "67") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "38"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais2'] == "67") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "40*"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df['nais2'] == "67") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais2'] == "67") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais2'] == "29C") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "29C collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais2'] == "67G") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "40*"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df['nais2'] == "67G") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "38"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df['nais2'] == "67G") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais2'] == "67G") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais2'] == "57VMTa") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "51 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais2'] == "29A") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "29A collin"
    # combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais2'] == "57VMLä") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "51 collin"
    # combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais2'] == "57VMLä") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk2"] = "51"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais2'] == "52ReG") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "52 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais2'] == "68") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "68 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais2'] == "68") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "68 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais2'] == "68") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk2"] = "68"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', 'J']) == True) & (combinations_df['nais2'] == "68") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "41* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', 'J', '2b', '3']) == True) & (combinations_df['nais2'] == "34*") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', 'J', '2b', '3']) == True) & (combinations_df['nais2'] == "25e") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "25e collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais2'] == "40PBl") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "40PBl collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais2'] == "67") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais2'] == "58CG") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk2"] = "55*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais2'] == "58CG") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "55* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '2c', 2, '3']) == True) & (combinations_df['nais2'] == "40Pt") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "40P collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais2'] == "28") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "28 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais2'] == "47H") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "34*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais2'] == "30") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "30 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'M', 'J']) == True) & (combinations_df['nais2'] == "62") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "62 collin"

    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais2'] == "67G") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "65 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['nais2'] == "60G") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "50 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([1, 2])) & (combinations_df['nais2'] == "60G") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk2"] = "50"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais2'] == "60G") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk2"] = "50Re"

    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais2'] == "32*G") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "26"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais2'] == "58L") & (combinations_df["tahsue"] == "obersubalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk2"] = "55*"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais2'] == "58L") & (combinations_df["tahsue"] == "obersubalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "55* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais2'] == "32*") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "26"
    combinations_df.loc[((combinations_df['storeg'].isin(['J','M','1','2a','2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais2'] == "61") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "61 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais2'] == "53") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "62"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais2'] == "53") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "53* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais2'] == "53") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "62"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais2'] == "53") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "53* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais2'] == "68*") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "68* collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3']) == True) & (combinations_df['taheute'].isin([3])) & (combinations_df['nais2'] == "68*") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "68* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', 'J', '2b', '3']) == True) & (combinations_df['nais2'] == "25e") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "25e collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df['nais2'] == "26h") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk2"] = "26"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df['nais2'] == "26h") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "26h"
    combinations_df.loc[((combinations_df['storeg'].isin([ '2b', '3'])) & (combinations_df['nais2'] == "68") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "68 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3'])) & (combinations_df['nais2'] == "24") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "24 collin"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3'])) & (combinations_df['nais2'] == "24") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk2"] = "24"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3'])) & (combinations_df['nais2'] == "59E") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk2"] = "53*"
    combinations_df.loc[((combinations_df['storeg'].isin(['2b', '3'])) & (combinations_df['nais2'] == "65*") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "65* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'M', 'J', '2b', '3'])) & (combinations_df['nais2'] == "44") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "44 collin"


    # correct VD
    combinations_df.loc[((combinations_df['storeg'].isin(['M', 'J']) == True) & (combinations_df['nais1'] == "16") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "39"
    combinations_df.loc[((combinations_df['storeg'].isin([1,'1',2, '2','2a','2b','3']) == True) & (combinations_df['nais1'] == "16") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "40*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3','J','M']) == True) & (combinations_df['nais1'] == "16") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "16"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M','J']) == True) & (combinations_df['nais1'] == "43") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "43"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J']) == True) & (combinations_df['nais1'] == "45") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "45"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J','2a']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "41* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2a']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "41* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2a']) == True) & (combinations_df['nais1'] == "34*") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "34* collin"
    ...
    # correct SG, neu mit G, Fe, und Lä Varianten
    ...
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 3, '3', 'J']) == True) & (combinations_df["nais1"] == "21G") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "21G"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 3, '3', 'J']) == True) & (combinations_df["nais1"] == "21G") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "7S"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 3, '3', 'J']) == True) & (combinations_df["nais1"] == "21G") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "7S"
    ...
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 3, '3', 'J']) == True) & (combinations_df["nais1"] == "12SFe") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "11Fe"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df['nais1'] == "24Fe") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "25"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df['nais1'] == "24Fe") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "24Fe"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df['nais1'] == "24Fe") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "25"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df['nais1'] == "24Fe") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "25"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df['nais1'] == "24Fe") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "25"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df['nais1'] == "25*Fe") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "25*Fe"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df['nais1'] == "8fFe") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "6Fe"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df['nais1'] == "8gFe") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "6Fe"

    # ue
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df['nais2'] == "8a(12a)") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "8a(12a)"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df['nais2'] == "9a") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "9a"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"].isin(["submontan", "untermontan", "obermontan", "unter- & obermontan", "hochmontan", "subalpin", "obersubalpin"]))), "naiszuk2"] = combinations_df['nais2']
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df["tahsue"] == "collin mit Buche") & (combinations_df["hszukcor"].isin(["submontan", "untermontan", "obermontan", "unter- & obermontan", "hochmontan", "subalpin", "obersubalpin"]))), "naiszuk2"] = combinations_df['nais2']
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df["tahsue"] == "hyperinsubrisch") & (combinations_df["hszukcor"].isin(["submontan", "untermontan", "obermontan", "unter- & obermontan", "hochmontan", "subalpin", "obersubalpin"]))), "naiszuk2"] = combinations_df['nais2']
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"].isin(["untermontan", "obermontan", "unter- & obermontan", "hochmontan", "subalpin", "obersubalpin"]))), "naiszuk2"] = combinations_df['nais2']
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"].isin(["obermontan", "unter- & obermontan", "hochmontan", "subalpin", "obersubalpin"]))), "naiszuk2"] = combinations_df['nais2']
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"].isin(["hochmontan", "subalpin", "obersubalpin"]))), "naiszuk2"] = combinations_df['nais2']
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df["tahsue"] == "unter- & obermontan") & (combinations_df["hszukcor"].isin(["hochmontan", "subalpin", "obersubalpin"]))), "naiszuk2"] = combinations_df['nais2']
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"].isin(["subalpin", "obersubalpin"]))), "naiszuk2"] = combinations_df['nais2']
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"].isin(["obersubalpin"]))), "naiszuk2"] = combinations_df['nais2']

    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df['nais2'] == "46*") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "7*"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df['nais2'] == "48G") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "22"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df['nais2'] == "53Ta") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "62"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df['nais2'] == "26h") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "26"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2])) & (combinations_df['nais2'] == "48G") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "22"
    ...
    combinations_df.loc[((combinations_df['storeg'].isin(['M', 'J']) == True) & (combinations_df["nais2"] == "69G") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "65"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2b', '2c', '2a', 3, '3']) == True) & (combinations_df["nais2"] == "69G") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "65"
    combinations_df.loc[((combinations_df['storeg'].isin(['M', 'J']) == True) & (combinations_df["nais2"] == "69G") & (combinations_df["tahsue"] == "_") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "65"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2b', '2c', '2a', 3, '3']) == True) & (combinations_df["nais2"] == "69G") & (combinations_df["tahsue"] == "_") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "65"
    ...
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M']) == True) & (combinations_df['nais2'] == "59Lä") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "obermontan")), "naiszuk2"] = "18"
    ...
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df['nais2'] == "25*Fe") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "25*Fe"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df['nais2'] == "25*Fe") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "25* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df['nais2'] == "24Fe") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "25"
    ...
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['nais1'] == "65") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '65-kol'
    ...
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['nais2'] == "65") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = '65-kol'
    ...
    # correct GR
    #nais1
    combinations_df.loc[((combinations_df['storeg'].isin([5,'5','5a','5b',4,'4','4a','4b']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "42r"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "hyperinsubrisch")), "naiszuk1"] = "42r"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "mediterran")), "naiszuk1"] = "42r med"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "42r"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "42r"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "hyperinsubrisch")), "naiszuk1"] = "42r"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "mediterran")), "naiszuk1"] = "42r med"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b', 5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "42r"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b', 5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk1"] = "68"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b', 5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "unter- & obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "32C"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b', 5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "40Pt"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b', 5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "40Pt"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b', 5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "40Pt"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b', 5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "40Pt"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b', 5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk1"] = "40P"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b', 5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "mediterran")), "naiszuk1"] = "40Pt med"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5','5b','5a']) == True) & (combinations_df['nais1'] == "33V") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "3L/4L"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "33V") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "33m"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a']) == True) & (combinations_df['nais1'] == "33V") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "3L/4L"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "33V") & (combinations_df["tahs"] == "unter- & obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "3L/4L"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "33V") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk1"] = "19LP"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "33V") & (combinations_df["tahs"] == "unter- & obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "33m"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "33V") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk1"] = "33V"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "33V") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "mediterran")), "naiszuk1"] = "3L/4L med"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5','5b', '5a',4,'4','4a','4b']) == True) & (combinations_df['nais1'] == "24") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "25a"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "24") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25a"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "24") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "mediterran")), "naiszuk1"] = "25a med"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "24") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk1"] = "24"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "32*") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "27"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "32*") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "27"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "32*") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "mediterran")), "naiszuk1"] = "27 med"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "57Bl") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "25au"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "57Bl") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk1"] = "24*"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "25as"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25as"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "unter- & obermontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "25as"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "unter- & obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25as"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "25a") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "mediterran")), "naiszuk1"] = "25a med"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "25a") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "hyperinsubrisch")), "naiszuk1"] = "25a hyp"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "25a") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "25a"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "59A") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "3L/4L"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "58C") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "42Q"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "57C") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "34a"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "57V") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "34a"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "40PBlt"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "25as"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "40PBlt"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25as"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = "40PBl"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "25as"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25as"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "mediterran")), "naiszuk1"] = "25as med"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b', 5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk1"] = "40PBl"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "mediterran")), "naiszuk1"] = "40P med"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b',5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "40Pt"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "56") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk1"] = "27"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a']) == True) & (combinations_df['nais1'] == "57Bl") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk1"] = "24*"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a']) == True) & (combinations_df['nais1'] == "57Bl") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "mediterran")), "naiszuk1"] = "25au med"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5b', '5a']) == True) & (combinations_df['nais1'] == "57Bl") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk1"] = "24*"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b',5, '5', '5a', '5b']) == True) & (combinations_df['nais1'] == "57Bl") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25au"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "70") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "42r"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "70") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk1"] = "68"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "32V") & (combinations_df["tahs"] == "unter- & obermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "32C"
    combinations_df.loc[((combinations_df['nais1'] == "47M") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "34a"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) &(combinations_df['nais1'] == "25a") & (combinations_df["tahs"] == "collin mit Buche") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25a"
    #nais2
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b','2b']) == True) & (combinations_df['nais2'] == "46M") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk2"] = "3"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais2'] == "46M") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "colllin mit Buche")), "naiszuk2"] = "42V"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais2'] == "46MRe") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "3"
    combinations_df.loc[((combinations_df['storeg'].isin(['3','2a', '2b']) == True) & (combinations_df['nais2'] == "46M") & (combinations_df["tahsue"] == "obersubalpin") & (combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk2"] = "20"
    combinations_df.loc[((combinations_df['storeg'].isin(['3', '2a', '2b']) == True) & (combinations_df['nais2'] == "60*") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk2"] = "18w"
    #correct GR 2
    combinations_df.loc[combinations_df['nais'].isin(['71/71G', '67/67G', '70/70G']), 'tahsue'] = combinations_df['tahs']
    #test=combinations_df[((combinations_df['nais2'].isin(['71G', '67G', '70G']))&(combinations_df['naiszuk2'].isin(['no path', '', 'no path c','_'])))]
    #test2=test[['nais2','tahsue','hszukcor','storeg']]
    #test3=test2.drop_duplicates()
    combinations_df.loc[(combinations_df['nais'].isin(['71/71G', '67/67G', '70/70G'])&(combinations_df['tahsue']==combinations_df['hszukcor'])), 'naiszuk2'] = combinations_df['nais2']
    combinations_df.loc[((combinations_df['nais2']=='67G') & (
                combinations_df['tahsue'] == 'obersubalpin')&(combinations_df['hszukcor'] == 'subalpin')), 'naiszuk2'] = '67G'
    combinations_df.loc[((combinations_df['nais2'] == '67G') & (combinations_df['nais2'].isin(['2b','3']))&(
            combinations_df['tahsue'] == 'obersubalpin') & (combinations_df['hszukcor'] == 'collin')), 'naiszuk2'] = '65 collin'
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (combinations_df['nais1'] == "70") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "collin mit Buche")), "naiszuk1"] = "42r"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
                combinations_df['nais1'] == "59") & (combinations_df["tahs"] == "subalpin") & (
                                     combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = "47"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "59") & (combinations_df["tahs"] == "subalpin") & (
                                 combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25a"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b']) == True) & (
            combinations_df['nais1'] == "59") & (combinations_df["tahs"] == "subalpin") & (
                                 combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "42t"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "59") & (combinations_df["tahs"] == "subalpin") & (
                                 combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = "47"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "59") & (combinations_df["tahs"] == "subalpin") & (
                                 combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25a"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "47*") & (combinations_df["tahs"] == "unter- & obermontan") & (
                                 combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "3LV"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "untermontan") & (
                                 combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25as"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "unter- & obermontan") & (
                                 combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "25as"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "47") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "19a"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "47") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "19a"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "33V") & (combinations_df["tahs"] == "unter- & obermontan") & (
                                 combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "33V"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "57C") & (combinations_df["tahs"] == "unter- & obermontan") & (
                                 combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "3"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "59*") & (combinations_df["tahs"] == "subalpin") & (
                                 combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "4"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "59*") & (combinations_df["tahs"] == "subalpin") & (
                                 combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "4"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "47DRe") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "19L"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "unter- & obermontan") & (
                                 combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "40P"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "unter- & obermontan") & (
                                 combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "40P"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (
            combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "unter- & obermontan") & (
                                 combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "40P"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (
            combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "unter- & obermontan") & (
                                 combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "40P"
    combinations_df.loc[
        ((combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (
                combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "unter- & obermontan") & (
                 combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "6"
    combinations_df.loc[
        ((combinations_df['storeg'].isin(['2b', '3']) == True) & (
                combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "unter- & obermontan") & (
                 combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "40P collin"
    combinations_df.loc[
        ((combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', 'J']) == True) & (
                combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "unter- & obermontan") & (
                 combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "6 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "55*") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "3s"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "55*") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "3s"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "untermontan") & (
                                 combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "40PBlt"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b']) == True) & (
            combinations_df['nais1'] == "40PBl") & (combinations_df["tahs"] == "untermontan") & (
                                 combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25as"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "47D") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "19L"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "47D") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "19L"
    combinations_df.loc[(
                (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (
                    combinations_df['nais1'] == "32V") & (combinations_df["tahs"] == "unter- & obermontan") & (
                            combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '32C collin'
    combinations_df.loc[(
            (combinations_df['storeg'].isin(['2b', '3']) == True) & (
            combinations_df['nais1'] == "32V") & (combinations_df["tahs"] == "unter- & obermontan") & (
                    combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '24 collin'
    combinations_df.loc[(
            (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a']) == True) & (
            combinations_df['nais1'] == "32V") & (combinations_df["tahs"] == "unter- & obermontan") & (
                    combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '25 collin'
    combinations_df.loc[(
            (combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "32V") & (combinations_df["tahs"] == "unter- & obermontan") & (
                    combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '32C'

    combinations_df.loc[(
            (combinations_df['storeg'].isin(['2b', '3']) == True) & (
            combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "unter- & obermontan") & (
                    combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '47H collin'
    combinations_df.loc[(
            (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a']) == True) & (
            combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "unter- & obermontan") & (
                    combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '34* collin'
    combinations_df.loc[(
            (combinations_df['storeg'].isin([4, '4', '4a', '4b',5,'5', '5a', '5b']) == True) & (
            combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "unter- & obermontan") & (
                    combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '25as'
    combinations_df.loc[(
            (combinations_df['storeg'].isin([4, '4', '4a', '4b', 5, '5', '5a', '5b']) == True) & (
            combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "obermontan") & (
                    combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk1"] = '47H'
    combinations_df.loc[(
            (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', 3, '3','4a','4b','4','5','5a','5b']) == True) & (
            combinations_df['nais1'] == "14") & (combinations_df["tahs"] == "obermontan") & (
                    combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = '14'
    combinations_df.loc[(
            (combinations_df['storeg'].isin([4, '4', '4a', '4b', 5, '5', '5a', '5b']) == True) & (
            combinations_df['nais1'] == "47H") & (combinations_df["tahs"] == "untermontan") & (
                    combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '25as'
    combinations_df.loc[(
            (combinations_df['storeg'].isin(
                [1, '1', 'M', 2, '2', '2a', 3, '3', '4a', '4b', '4', '5', '5a', '5b']) == True) & (
                    combinations_df['nais1'] == "58C") & (combinations_df["tahs"] == "subalpin") & (
                    combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = '3s'
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "53*") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "14*"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "58L") & (combinations_df["tahs"] == "subalpin") & (
                                 combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "3s"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "25a") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "25a"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "25a") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "25a"
    combinations_df.loc[(
            (combinations_df['storeg'].isin(
                [1, '1', 'M', 2, '2', '2a', 3, '3', '4a', '4b', '4', '5', '5a', '5b']) == True) & (
                    combinations_df['nais1'] == "AV") & (combinations_df["tahs"] == "hochmontan") & (
                    combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = 'AV'
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "47D") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "19L"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "59A") & (combinations_df["tahs"] == "obersubalpin") & (
                                 combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "19L"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "57C") & (combinations_df["tahs"] == "subalpin") & (
                                 combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "3"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "32*") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "32*"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "60A") & (combinations_df["tahs"] == "subalpin") & (
                                 combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "19L"
    combinations_df.loc[(
            (combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (
            combinations_df['nais1'] == "40P") & (combinations_df["tahs"] == "unter- & obermontan") & (
                    combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '40P collin'
    combinations_df.loc[(
            (combinations_df['storeg'].isin(['2b', '2c', 3, '3']) == True) & (
            combinations_df['nais1'] == "46M") & (combinations_df["tahs"] == "hochmontan") & (
                    combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '46M collin'
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b']) == True) & (
            combinations_df['nais1'] == "47*Lä") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "3LV"
    combinations_df.loc[((combinations_df['storeg'].isin([4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "47*Lä") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "3LV"
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b',4, '4', '4a', '4b']) == True) & (
            combinations_df['nais1'] == "47*Lä") & (combinations_df["tahs"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk1"] = "4"
    #nais 2
    combinations_df.loc[((combinations_df['storeg'].isin([5, '5', '5a', '5b', 4, '4', '4a', '4b']) == True) & (
            combinations_df['nais2'] == "70G") & (combinations_df["tahsue"] == "hochmontan") & (
                                 combinations_df["hszukcor"] == "unter- & obermontan")), "naiszuk2"] = "68"


    # correct collin-->collin
    # nais1
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "25A") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "23H collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "25Q") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "52 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "35") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "15 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "35A") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "7a collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "35M") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "17 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "38S") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "65* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "40*") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "40* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "25e") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25e collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "25*") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "25* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "28") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "28 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "29A") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "29A collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "29C") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "29C collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "30") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "30 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "31") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "31 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "32C") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "32C collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "34*") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "40Pt") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "40P collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "41") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "41 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "41*") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "41* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "43") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "43 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "43S") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "43S collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "44") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "44 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "65*") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "65* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais1'] == "66") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "66 collin"
    # nais2
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "25A") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "23H collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "25Q") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "52 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "35") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "15 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "35A") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "7a collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "35M") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "17 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "38S") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "65* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "40*") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "40* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "25e") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "25e collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "25*") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "25* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "28") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "28 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "29A") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "29A collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c',2,'3']) == True) & (combinations_df['nais2'] == "29C") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "29C collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "30") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "30 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "31") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "31 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "32C") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "32C collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "34*") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "40Pt") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "40P collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "41") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "41 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "41*") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "41* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "43") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "43 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "43S") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "43S collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "44") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "44 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "65*") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "65* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2', '2a', '2b', '2c', 2,'3']) == True) & (combinations_df['nais2'] == "66") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "66 collin"
    ...
    for index, row in nopaths[["storegco", 'storeg', 'nais1', "tahs", "hszukcor"]].iterrows():
        if [row["storegco"], row["storeg"], row['nais1'], row["tahs"], row["hszukcor"]] not in listofnopathcombinations:
            listofnopathcombinations.append([row["storegco"], row["storeg"], row['nais1'], row["tahs"], row["hszukcor"]])
    ...
    for index, row in nopaths2[["storegco", 'storeg','nais2', "tahsue", "hszukcor"]].iterrows():
        if row['nais2'] != "_" and [row["storegco"], row["storeg"], row['nais2'], row["tahsue"],
                                    row["hszukcor"]] not in listofnopathcombinations2:
            listofnopathcombinations2.append([row["storegco"], row["storeg"], row['nais2'], row["tahsue"], row["hszukcor"]])
    len(listofnopathcombinations2)
    # listofnopathcombinations2.sort()
    # listofnopathcombinations
    nopathoutfile = open(projectspace + "/GR/" + climatescenario.lower() + "_listofnopathcombinations.txt", "w")
    nopathoutfile.write("standortregion;storeg;nais;hsheute;hszukunft\n")
    for item in listofnopathcombinations:
        nopathoutfile.write(str(item[0]) + ";" + str(item[1]) + ";" + str(item[2]) + ";" + str(item[3]) + ";" + str(item[4])+ "\n")
    nopathoutfile.write("#nais2\n")
    for item in listofnopathcombinations2:
        nopathoutfile.write(str(item[0]) + ";" + str(item[1]) + ";" + str(item[2]) + ";" + str(item[3])+ ";" + str(item[4])+ "\n")
    nopathoutfile.close()
    joblib.dump(combinations_df, projectspace + "/GR" + "GR_" + climatescenario + "_combinations_df_futureSTO.sav")
    #combinations_df=joblib.load(projectspace + "/GR" + "GR_" + climatescenario + "_combinations_df_futureSTO.sav")
    combinations_df.to_file(projectspace + "/GR/" + "GR_" + climatescenario + "_zukuenftigestandorte.gpkg")
    ...
    joblib.dump(gr_treetypes_LFI, projectspace + "/GR/" + "treetypes_LFI.sav")

    naismatrix_gr_df = naismatrixdf[naismatrixdf["Abkuerzung"].isin(gr_treetypes_LFI)]
    len(naismatrix_gr_df)
    joblib.dump(naismatrix_gr_df, projectspace + "/GR/" + "naismatrix_gr_df.sav")
    ...
    joblib.dump(combinations_df_bedeutung,
                projectspace + "/GR" + "/GR_" + climatescenario.lower() + "_combinations_df_baumartenbedeutungen.sav")
    ...
    combinations_df_bedeutung.to_file(projectspace + "/GR" + "/GR_" + climatescenario + "_baumartenbedeutungen.gpkg",
                                      layer="GR_" + climatescenario + "_baumartenbedeutungen", driver="GPKG")
        ...
        combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["ue"] == 1) & (
            combinations_df_baumartenempfehlung[col + "zukUE"].isin(["c"])) & (
                                                     ~combinations_df_baumartenempfehlung[col + "heuUE"].isin(
                                                         ["a", "b", "c"]))), col] = 5
    # Arve
    combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["nais1"].isin(arvenundlaerchen)) & (combinations_df_baumartenempfehlung["tahs"] == 'obersubalpin') & (combinations_df_baumartenempfehlung["hszukcor"] == 'hochmontan')), 'GR_'] = 6
    ...
    joblib.dump(combinations_df_baumartenempfehlung,
                projectspace + "/GR" + "/GR_" + climatescenario.lower() + "_baumartenempfehlungen.sav")
    combinations_df_baumartenempfehlung.to_file(
        projectspace + "/GR" + "/GR_" + climatescenario + "_baumartenempfehlungen.gpkg",
        layer="GR_" + climatescenario + "_baumartenempfehlungen", driver="GPKG")
    ...
    joblib.dump(combinations_df_senstivestandorte,
                projectspace + "/GR" + "/GR_" + climatescenario.lower() + "_sensitivestandorte.sav")
    combinations_df_senstivestandorte.to_file(
        projectspace + "/GR" + "/GR_" + climatescenario + "_sensitivestandorte.gpkg",
        layer="GR_" + climatescenario + "_sensitivestandorte", driver="GPKG")
    combinations_df.columns

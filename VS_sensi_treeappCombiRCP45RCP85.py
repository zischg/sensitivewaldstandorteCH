...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/VS"+"/VS_rcp45_baumartenempfehlungen.gpkg", layer="VS_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/VS"+"/VS_rcp45_baumartenbedeutungen.gpkg", layer="VS_rcp45_baumartenbedeutungen", driver="GPKG")
baumartenbedeutungenrcp85=gpd.read_file(projectspace+"/VS"+"/VS_rcp85_baumartenbedeutungen.gpkg", layer="VS_rcp85_baumartenbedeutungen", driver="GPKG")
...
combi.to_file(projectspace+"/VS"+"/VS_baumartenempfehlungen_combi.gpkg", layer="VS_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

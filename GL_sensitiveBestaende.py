...
rcp_bk_gdf_out.to_file(projectspace+"/GL/"+"GL_"+climatescenario+"_sensitivebestaende"+str(fichtenanteil)+".gpkg")
#del rcp_bk_gdf_in
...
bk_gdf.to_file(projectspace+"/GL/"+"GL_"+climatescenario+"_bk_maxsensitivitaet"+str(fichtenanteil)+".gpkg")

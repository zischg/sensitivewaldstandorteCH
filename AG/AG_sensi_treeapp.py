...
treeapp=gpd.read_file(projectspace+"/AG/stok_gdf_attributed.gpkg", layer='stok_gdf_attributed')
treeapp.columns
treeapp.loc[treeapp['nais1']=='29a', 'nais1']='29A'
treeapp.loc[treeapp['nais2']=='29a', 'nais2']='29A'
treeapp.loc[treeapp['nais2']=='12', 'nais2']='12a'
#treeapp.loc[treeapp['nais2']=='8', 'nais2']='8a'
#treeapp.to_file(projectspace+"/AG/stok_gdf_attributed.gpkg", layer='stok_gdf_attributed')
treeapp.crs
...
for col in naismatrixdf.columns[8:].tolist():
    ...
    id+=1
joblib.dump(nais_matrix_standorte_list,projectspace+"/AG/"+"nais_matrix_standorte_list.sav")
...
treeapp.columns
len(treeapp)
checknotahs=treeapp[((treeapp['tahs']=='')&(treeapp['hs']!=''))]
for climatescenario in climatescenarios:
    print(climatescenario)
    ccgdf=gpd.read_file(projectspace+"/AG/ag_vegetationshoehenstufen_"+climatescenario+".gpkg", layer='ag_vegetationshoehenstufen_'+climatescenario)
    ccgdf.crs
    len(ccgdf)
    ...
    combinations_df=combinations_df[['STAO_87', 'STANDORT','nais', 'nais1', 'nais2', 'mo', 'ue','hs1975','taheute','storeg', 'tahs','tahsue', 'meanslopeprc', 'slpprzrec', 'lage','rad', 'radiation', 'HS_de', 'Code', 'Subcode','geometry']]
    combinations_df.columns
    ...
    joblib.dump(combinations_df, projectspace+"/AG/combinations_df"+climatescenario+".sav")
    combinations_df.columns
    ...
    # correct AI
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 3, '3', 'J']) == True) & (combinations_df["nais1"] == "23Fe") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "16"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df["nais1"] == "23Fe") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "39"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', '2a', '2b', 3, '3']) == True) & (combinations_df["nais1"] == "23Fe") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "40*"
    # ue
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 3, '3', 'J']) == True) & (combinations_df["nais2"] == "20G") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "8S"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 3, '3', 'J']) == True) & (combinations_df["nais2"] == "20G") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "7S"
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] <= 20) & (combinations_df["nais2"] == "57V") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "obermontan")), "naiszuk2"] = "46"
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] > 20) & (combinations_df["nais2"] == "57V") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "obermontan")), "naiszuk2"] = "19"
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] <= 20) & (combinations_df["nais2"] == "57V") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "8*"
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] > 20) & (combinations_df["nais2"] == "57V") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "8d"
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] <= 20) & (combinations_df["nais2"] == "57V") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "7*"
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 3, '3', 'J']) == True) & (combinations_df['meanslopeprc'] > 20) & (combinations_df["nais2"] == "57V") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "6"
    ...
    # correct AG
    #nais1
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais1'] == "41") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "41"
    #ue
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b','J']) == True) & (combinations_df['nais2'] == "11") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "11"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "11") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "11 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "11") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "11 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "12a") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "9a"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "10a") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "10a collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df['nais2'] == "13a") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "13a collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', 'J']) == True) & (combinations_df['nais2'] == "9a") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "9a collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "8a") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "7a"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "22") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "22"
    ...
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 2, '2', '2a', '2b', '2c', 3, '3', 'J']) == True) & (combinations_df['nais1'] == "66L") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '66L-kol'
    # nais2
    ...
    # listofnopathcombinations
    nopathoutfile = open(projectspace + "/AG/" + climatescenario.lower() + "_listofnopathcombinations.txt", "w")
    ...
    for item in listofnopathcombinations2:
        nopathoutfile.write(str(item[0]) + ";" + str(item[1]) + ";" + str(item[2]) + ";" + str(item[3]) + "\n")
    nopathoutfile.close()
    joblib.dump(combinations_df, projectspace + "/AG" + "AG_" + climatescenario + "_combinations_df_futureSTO.sav")
    combinations_df.to_file(projectspace + "/AG/" + "AG_" + climatescenario + "_zukuenftigestandorte.gpkg")
    ...
    joblib.dump(gr_treetypes_LFI, projectspace + "/AG/" + "treetypes_LFI.sav")

    naismatrix_gr_df = naismatrixdf[naismatrixdf["Abkuerzung"].isin(gr_treetypes_LFI)]
    len(naismatrix_gr_df)
    joblib.dump(naismatrix_gr_df, projectspace + "/AG/" + "naismatrix_gr_df.sav")
    ...
    joblib.dump(combinations_df_bedeutung,
                projectspace + "/AG" + "/AG_" + climatescenario.lower() + "_combinations_df_baumartenbedeutungen.sav")
    ...
    combinations_df_bedeutung.to_file(projectspace + "/AG" + "/AG_" + climatescenario + "_baumartenbedeutungen.gpkg",
                                      layer="AG_" + climatescenario + "_baumartenbedeutungen", driver="GPKG")
        ...
        combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["ue"] == 1) & (
            combinations_df_baumartenempfehlung[col + "zukUE"].isin(["c"])) & (
                                                     ~combinations_df_baumartenempfehlung[col + "heuUE"].isin(
                                                         ["a", "b", "c"]))), col] = 5
    # Arve
    combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["nais1"].isin(arvenundlaerchen)) & (combinations_df_baumartenempfehlung["tahs"] == 'obersubalpin') & (combinations_df_baumartenempfehlung["hszukcor"] == 'hochmontan')), 'AG_'] = 6
    ...
    joblib.dump(combinations_df_baumartenempfehlung,
                projectspace + "/AG" + "/AG_" + climatescenario.lower() + "_baumartenempfehlungen.sav")
    combinations_df_baumartenempfehlung.to_file(
        projectspace + "/AG" + "/AG_" + climatescenario + "_baumartenempfehlungen.gpkg",
        layer="AG_" + climatescenario + "_baumartenempfehlungen", driver="GPKG")
    ...
    joblib.dump(combinations_df_senstivestandorte,
                projectspace + "/AG" + "/AG_" + climatescenario.lower() + "_sensitivestandorte.sav")
    # combinations_df_senstivestandorte.to_file(projectspace+"/A"+"/A_"+climatescenario+"_sensitivestandorte.shp")
    combinations_df_senstivestandorte.to_file(
        projectspace + "/AG" + "/AG_" + climatescenario + "_sensitivestandorte.gpkg",
        layer="AG_" + climatescenario + "_sensitivestandorte", driver="GPKG")
    combinations_df.columns
    # combinations_df.to_file(projectspace+"/AG/"+"AG_"+climatescenario+"_zukuenftigestandorte.shp")
    ...
    # combinations_df=joblib.load(projectspace+"/AG"+"/AG_"+climatescenario.lower()+"_zukuenftigestandorte.sav")
    # combinations_df_bedeutung.to_file(projectspace+"/"+"sg_"+climatescenario+"_baumartenbedeutungen.shp")
    ...
    # combinations_df_baumartenempfehlung.to_file(projectspace+"/AG/"+"AG_"+climatescenario+"_baumartenempfehlungen.shp")

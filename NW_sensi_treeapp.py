...
treeapp=gpd.read_file(projectspace+"/NW/stok_gdf_attributed.gpkg", layer='stok_gdf_attributed')
treeapp.crs
...
for col in naismatrixdf.columns[8:].tolist():
    ...
    id+=1
joblib.dump(nais_matrix_standorte_list,projectspace+"/NW/"+"nais_matrix_standorte_list.sav")
...
for climatescenario in climatescenarios:
    ...
    ccgdf=gpd.read_file(projectspace+"/NW/vegetationshoehenstufen_"+climatescenario+".gpkg", layer='vegetationshoehenstufen_'+climatescenario)
    ccgdf.crs
    len(ccgdf)
    ...
    combinations_df=combinations_df[['Beschriftu', 'Art_1', 'Art_2', 'Art_Ueberg','nais', 'nais1', 'nais2', 'mo', 'ue','hs1975','taheute','storeg', 'tahs','tahsue', 'meanslopeprc', 'slpprzrec', 'lage','rad', 'radiation', 'HS_de', 'Code', 'Subcode','geometry']]
    combinations_df.columns
    ...
    joblib.dump(combinations_df, projectspace+"/NW/combinations_df"+climatescenario+".sav")
    combinations_df.columns
    ...
    # correct NW
    # ue
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2]))&(combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais1'] == "60") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk1"] = "50"
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais1'] == "60") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "obermontan")), "naiszuk1"] = "20"
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais1'] == "60") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "8S"
    combinations_df.loc[((combinations_df['taheute'].isin([1, 2])) & (combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais1'] == "60") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "7S"
    ...
    # listofnopathcombinations
    nopathoutfile = open(projectspace + "/NW/" + climatescenario.lower() + "_listofnopathcombinations.txt", "w")
    ...
    for item in listofnopathcombinations2:
        nopathoutfile.write(str(item[0]) + ";" + str(item[1]) + ";" + str(item[2]) + ";" + str(item[3]) + "\n")
    nopathoutfile.close()
    joblib.dump(combinations_df, projectspace + "/NW" + "NW_" + climatescenario + "_combinations_df_futureSTO.sav")
    combinations_df.to_file(projectspace + "/NW/" + "NW_" + climatescenario + "_zukuenftigestandorte.gpkg")
    ...
    joblib.dump(gr_treetypes_LFI, projectspace + "/NW/" + "treetypes_LFI.sav")

    naismatrix_gr_df = naismatrixdf[naismatrixdf["Abkuerzung"].isin(gr_treetypes_LFI)]
    len(naismatrix_gr_df)
    joblib.dump(naismatrix_gr_df, projectspace + "/NW/" + "naismatrix_gr_df.sav")
    ...
    joblib.dump(combinations_df_bedeutung,
                projectspace + "/NW" + "/NW_" + climatescenario.lower() + "_combinations_df_baumartenbedeutungen.sav")
    ...
    combinations_df_bedeutung.to_file(projectspace + "/NW" + "/NW_" + climatescenario + "_baumartenbedeutungen.gpkg",
                                      layer="NW_" + climatescenario + "_baumartenbedeutungen", driver="GPKG")
    # sqlstatement='SELECT * NWOM public.grnaistahsstoregclip6190'+climatescenario+'_zukuenftigestandorte;'
        ...
        combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["ue"] == 1) & (
            combinations_df_baumartenempfehlung[col + "zukUE"].isin(["c"])) & (
                                                     ~combinations_df_baumartenempfehlung[col + "heuUE"].isin(
                                                         ["a", "b", "c"]))), col] = 5
    # Arve
    combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["nais1"].isin(arvenundlaerchen)) & (combinations_df_baumartenempfehlung["tahs"] == 'obersubalpin') & (combinations_df_baumartenempfehlung["hszukcor"] == 'hochmontan')), 'NW_'] = 6
    ...
    joblib.dump(combinations_df_baumartenempfehlung,
                projectspace + "/NW" + "/NW_" + climatescenario.lower() + "_baumartenempfehlungen.sav")
    combinations_df_baumartenempfehlung.to_file(
        projectspace + "/NW" + "/NW_" + climatescenario + "_baumartenempfehlungen.gpkg",
        layer="NW_" + climatescenario + "_baumartenempfehlungen", driver="GPKG")
    ...
    joblib.dump(combinations_df_senstivestandorte,
                projectspace + "/NW" + "/NW_" + climatescenario.lower() + "_sensitivestandorte.sav")
    # combinations_df_senstivestandorte.to_file(projectspace+"/NW"+"/NW_"+climatescenario+"_sensitivestandorte.shp")
    combinations_df_senstivestandorte.to_file(
        projectspace + "/NW" + "/NW_" + climatescenario + "_sensitivestandorte.gpkg",
        layer="NW_" + climatescenario + "_sensitivestandorte", driver="GPKG")
    combinations_df.columns
    # combinations_df.to_file(projectspace+"/NW/"+"NW_"+climatescenario+"_zukuenftigestandorte.shp")
    ...
    # combinations_df=joblib.load(projectspace+"/NW"+"/NW_"+climatescenario.lower()+"_zukuenftigestandorte.sav")
    # combinations_df_bedeutung.to_file(projectspace+"/"+"sg_"+climatescenario+"_baumartenbedeutungen.shp")
    ...
    # combinations_df_baumartenempfehlung.to_file(projectspace+"/NW/"+"NW_"+climatescenario+"_baumartenempfehlungen.shp")

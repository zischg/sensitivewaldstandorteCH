...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/ZG"+"/ZG_rcp45_baumartenempfehlungen.gpkg", layer="ZG_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/ZG"+"/ZG_rcp45_baumartenbedeutungen.gpkg", layer="ZG_rcp45_baumartenbedeutungen", driver="GPKG")
baumartenbedeutungenrcp85=gpd.read_file(projectspace+"/ZG"+"/ZG_rcp85_baumartenbedeutungen.gpkg", layer="ZG_rcp85_baumartenbedeutungen", driver="GPKG")
...
combi.to_file(projectspace+"/ZG"+"/ZG_baumartenempfehlungen_combi.gpkg", layer="ZG_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

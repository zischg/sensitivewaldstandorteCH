...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/OW"+"/OW_rcp45_baumartenempfehlungen.gpkg", layer="OW_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/OW"+"/OW_rcp45_baumartenbedeutungen.gpkg", layer="OW_rcp45_baumartenbedeutungen", driver="GPKG")
baumartenbedeutungenrcp85=gpd.read_file(projectspace+"/OW"+"/OW_rcp85_baumartenbedeutungen.gpkg", layer="OW_rcp85_baumartenbedeutungen", driver="GPKG")
...
'geometry' in colist
combi.to_file(projectspace+"/OW"+"/OW_baumartenempfehlungen_combi.gpkg", layer="OW_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

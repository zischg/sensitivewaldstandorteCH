...
labels_zahlen = areastatistics.index.get_level_values('sensisto').tolist()
print(labels_zahlen)
...
ax.axis('equal')
# Set title
ax.set_title('RCP 4.5 Sensitive Standorte CH', fontsize=12, fontweight='bold',pad=20)
...
for region in storeg_list:
    ...
    ax.axis('equal')
    # Set title
    ax.set_title('RCP 4.5 Sensitive Standorte Region '+region, fontsize=12, fontweight='bold',pad=20)
    # CREATE CUSTOM LEGEND WITH LABELS
    legend_labels = sensisto_labels
    ax.legend(
        wedges,
...
#create a pie chart for CH
labels_zahlen85 = areastatistics85.index.get_level_values('sensisto').tolist()
print(labels_zahlen85)
print(sensisto_labels)
...
ax.axis('equal')
# Set title
ax.set_title('RCP 8.5 Sensitive Standorte CH', fontsize=12, fontweight='bold',pad=20)
# CREATE CUSTOM LEGEND WITH LABELS
legend_labels = sensisto_labels
ax.legend(
    wedges,

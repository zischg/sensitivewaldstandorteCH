...
naiseinheitenunique=naiseinheitenunique[['BE', 'NaiS_LFI_JU', 'NaiS_LFI_M/A','hs', 'hsue','Bemerkungen bh', 'Bemerkung Monika']]
naiseinheitenunique.loc[naiseinheitenunique['hsue'].isnull()==True, 'nais2']=''

#naiseinheitenunique=naiseinheitenunique[naiseinheitenunique['hs']!='nan']
#read the rasters
#reference tif raster
print("read reference raster")
referenceraster=myworkspace+"/BE/BE_dem10m.tif"
...
sloperaster=myworkspace+"/BE/BE_slopeprz.tif"
radiationraster=myworkspace+"/BE/BE_globradyyw.tif"
hoehenstufenraster=myworkspace+"/BE/BE_vegetationshoehenstufen1975.tif"


#read shapefile
stok_gdf=gpd.read_file(myworkspace+'/BE/bafu_baumartenempf_sens_standorte_20240212/stao_staohk_arrond_20240212.shp')
...
stok_gdf.to_file(myworkspace+"/BE/stok_gdf_attributed.gpkg",layer='stok_gdf_attributed', driver="GPKG")
print("done")

...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/GE"+"/GE_rcp45_baumartenempfehlungen.gpkg", layer="GE_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/GE"+"/GE_rcp45_baumartenbedeutungen.gpkg", layer="GE_rcp45_baumartenbedeutungen", driver="GPKG")
baumartenbedeutungenrcp85=gpd.read_file(projectspace+"/GE"+"/GE_rcp85_baumartenbedeutungen.gpkg", layer="GE_rcp85_baumartenbedeutungen", driver="GPKG")
...
combi.to_file(projectspace+"/GE"+"/GE_baumartenempfehlungen_combi.gpkg", layer="GE_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

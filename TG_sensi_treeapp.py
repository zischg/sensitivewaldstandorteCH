...
treeapp=gpd.read_file(projectspace+"/TG/stok_gdf_attributed.gpkg", layer='stok_gdf_attributed')
treeapp.columns
treeapp=treeapp[['joinid', 'TGneu', 'taheute', 'storeg','meanslopeprc', 'slpprzrec', 'rad', 'radiation', 'hs1975', 'nais1', 'nais2', 'mo', 'ue', 'tahs', 'tahsue', 'geometry']]
...
#treeapp.to_file(projectspace+"/TG/stok_gdf_attributed.gpkg",layer='stok_gdf_attributed', driver="GPKG")
...
for col in naismatrixdf.columns[8:].tolist():
    ...
    id+=1
joblib.dump(nais_matrix_standorte_list,projectspace+"/TG/"+"nais_matrix_standorte_list.sav")
...
for climatescenario in climatescenarios:
    ...
    ccgdf=gpd.read_file(projectspace+"/TG/TG_vegetationshoehenstufen_"+climatescenario+".gpkg", layer='TG_vegetationshoehenstufen_'+climatescenario)
    ccgdf.crs
    len(ccgdf)
    print("Overlay ...")
    ...
    combinations_df=combinations_df[['TGneu', 'nais','nais1', 'nais2', 'mo', 'ue','hs1975','taheute','storeg', 'tahs','tahsue', 'meanslopeprc', 'slpprzrec', 'lage','rad', 'radiation', 'HS_de', 'Code', 'Subcode','geometry']]
    combinations_df.columns
    ...
    joblib.dump(combinations_df, projectspace+"/TG/combinations_df"+climatescenario+".sav")
    combinations_df.columns
    ...
    # correct TG
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M','2',2,'2a','2b','J']) == True) & (combinations_df['nais2'] == "35") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "15 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2', 2, '2a', '2b', 'J']) == True) & (combinations_df['nais1'] == "10w") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "10w collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2', 2, '2a', 'J']) == True) & (combinations_df['nais1'] == "26") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "26 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2', 2, '2a', '2b', 'J']) == True) & (combinations_df['nais1'] == "29") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "29 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2', 2, '2a', 'J']) == True) & (combinations_df['nais1'] == "29A") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "29A collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2', 2, '2a', 'J']) == True) & (combinations_df['nais2'] == "43") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "43 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2', 2, '2a', 'J']) == True) & (combinations_df['nais2'] == "29") & (combinations_df["tahsue"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = "29 collin"
    ...
    # listofnopathcombinations
    nopathoutfile = open(projectspace + "/TG/" + climatescenario.lower() + "_listofnopathcombinations.txt", "w")
    ...
    for item in listofnopathcombinations2:
        nopathoutfile.write(str(item[0]) + ";" + str(item[1]) + ";" + str(item[2]) + ";" + str(item[3]) + "\n")
    nopathoutfile.close()
    joblib.dump(combinations_df, projectspace + "/TG" + "TG_" + climatescenario + "_combinations_df_futureSTO.sav")
    combinations_df.to_file(projectspace + "/TG/" + "TG_" + climatescenario + "_zukuenftigestandorte.gpkg")
    ...
    joblib.dump(gr_treetypes_LFI, projectspace + "/TG/" + "treetypes_LFI.sav")

    naismatrix_gr_df = naismatrixdf[naismatrixdf["Abkuerzung"].isin(gr_treetypes_LFI)]
    len(naismatrix_gr_df)
    joblib.dump(naismatrix_gr_df, projectspace + "/TG/" + "naismatrix_gr_df.sav")
    ...
    joblib.dump(combinations_df_bedeutung,
                projectspace + "/TG" + "/TG_" + climatescenario.lower() + "_combinations_df_baumartenbedeutungen.sav")
    ...
    combinations_df_bedeutung.to_file(projectspace + "/TG" + "/TG_" + climatescenario + "_baumartenbedeutungen.gpkg",
                                      layer="TG_" + climatescenario + "_baumartenbedeutungen", driver="GPKG")
        ...
        combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["ue"] == 1) & (
            combinations_df_baumartenempfehlung[col + "zukUE"].isin(["c"])) & (
                                                     ~combinations_df_baumartenempfehlung[col + "heuUE"].isin(
                                                         ["a", "b", "c"]))), col] = 5
    # Arve
    combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["nais1"].isin(arvenundlaerchen)) & (combinations_df_baumartenempfehlung["tahs"] == 'obersubalpin') & (combinations_df_baumartenempfehlung["hszukcor"] == 'hochmontan')), 'TG_'] = 6
    ...
    joblib.dump(combinations_df_baumartenempfehlung,
                projectspace + "/TG" + "/TG_" + climatescenario.lower() + "_baumartenempfehlungen.sav")
    combinations_df_baumartenempfehlung.to_file(
        projectspace + "/TG" + "/TG_" + climatescenario + "_baumartenempfehlungen.gpkg",
        layer="TG_" + climatescenario + "_baumartenempfehlungen", driver="GPKG")
    ...
    joblib.dump(combinations_df_senstivestandorte,
                projectspace + "/TG" + "/TG_" + climatescenario.lower() + "_sensitivestandorte.sav")
    combinations_df_senstivestandorte.to_file(
        projectspace + "/TG" + "/TG_" + climatescenario + "_sensitivestandorte.gpkg",
        layer="TG_" + climatescenario + "_sensitivestandorte", driver="GPKG")
    combinations_df.columns

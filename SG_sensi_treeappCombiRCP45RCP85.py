...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/SG"+"/SG_rcp45_baumartenempfehlungen.gpkg", layer="SG_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/SG"+"/SG_rcp45_baumartenbedeutungen.gpkg", layer="SG_rcp45_baumartenbedeutungen", driver="GPKG")
baumartenbedeutungenrcp85=gpd.read_file(projectspace+"/SG"+"/SG_rcp85_baumartenbedeutungen.gpkg", layer="SG_rcp85_baumartenbedeutungen", driver="GPKG")
...
combi.to_file(projectspace+"/SG"+"/SG_baumartenempfehlungen_combi.gpkg", layer="SG_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

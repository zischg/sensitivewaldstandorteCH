...
treeapp=gpd.read_file(projectspace+"/VS/stok_gdf_attributed.gpkg", layer='stok_gdf_attributed')
treeapp.columns
...
for col in naismatrixdf.columns[8:].tolist():
    ...
    id+=1
joblib.dump(nais_matrix_standorte_list,projectspace+"/VS/"+"nais_matrix_standorte_list.sav")
...
for climatescenario in climatescenarios:
    ...
    ccgdf=gpd.read_file(projectspace+"/VS/VS_vegetationshoehenstufen_"+climatescenario+".gpkg", layer='VS_vegetationshoehenstufen_'+climatescenario)
    #ccgdf.crs
    #len(ccgdf)
    print("Overlay ...")
    combinations_df=treeapp.overlay(ccgdf, how='intersection')
    #combinations_df = gpd.read_file(projectspace+"/VS/stok_gdf_attributed_"+climatescenario+".gpkg", layer='stok_gdf_attributed_'+climatescenario)
    ...
    joblib.dump(combinations_df, projectspace+"/VS/combinations_df"+climatescenario+".sav")
    combinations_df.columns
    ...
    # listofnopathcombinations
    nopathoutfile = open(projectspace + "/VS/" + climatescenario.lower() + "_listofnopathcombinations.txt", "w")
    ...
    for item in listofnopathcombinations2:
        nopathoutfile.write(str(item[0]) + ";" + str(item[1]) + ";" + str(item[2]) + ";" + str(item[3])+ ";" + str(item[4])+ "\n")
    nopathoutfile.close()
    joblib.dump(combinations_df, projectspace + "/VS" + "VS_" + climatescenario + "_combinations_df_futureSTO.sav")
    combinations_df.to_file(projectspace + "/VS/" + "VS_" + climatescenario + "_zukuenftigestandorte.gpkg")
    ...
    joblib.dump(gr_treetypes_LFI, projectspace + "/VS/" + "treetypes_LFI.sav")

    naismatrix_gr_df = naismatrixdf[naismatrixdf["Abkuerzung"].isin(gr_treetypes_LFI)]
    len(naismatrix_gr_df)
    joblib.dump(naismatrix_gr_df, projectspace + "/VS/" + "naismatrix_gr_df.sav")
    ...
    joblib.dump(combinations_df_bedeutung,
                projectspace + "/VS" + "/VS_" + climatescenario.lower() + "_combinations_df_baumartenbedeutungen.sav")
    ...
    combinations_df_bedeutung.to_file(projectspace + "/VS" + "/VS_" + climatescenario + "_baumartenbedeutungen.gpkg",
                                      layer="VS_" + climatescenario + "_baumartenbedeutungen", driver="GPKG")
        ...
        combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["ue"] == 1) & (
            combinations_df_baumartenempfehlung[col + "zukUE"].isin(["c"])) & (
                                                     ~combinations_df_baumartenempfehlung[col + "heuUE"].isin(
                                                         ["a", "b", "c"]))), col] = 5
    # Arve
    combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["nais1"].isin(arvenundlaerchen)) & (combinations_df_baumartenempfehlung["tahs"] == 'obersubalpin') & (combinations_df_baumartenempfehlung["hszukcor"] == 'hochmontan')), 'VS_'] = 6
    ...
    joblib.dump(combinations_df_baumartenempfehlung,
                projectspace + "/VS" + "/VS_" + climatescenario.lower() + "_baumartenempfehlungen.sav")
    combinations_df_baumartenempfehlung.to_file(
        projectspace + "/VS" + "/VS_" + climatescenario + "_baumartenempfehlungen.gpkg",
        layer="VS_" + climatescenario + "_baumartenempfehlungen", driver="GPKG")
    ...
    joblib.dump(combinations_df_senstivestandorte,
                projectspace + "/VS" + "/VS_" + climatescenario.lower() + "_sensitivestandorte.sav")
    combinations_df_senstivestandorte.to_file(
        projectspace + "/VS" + "/VS_" + climatescenario + "_sensitivestandorte.gpkg",
        layer="VS_" + climatescenario + "_sensitivestandorte", driver="GPKG")
    combinations_df.columns

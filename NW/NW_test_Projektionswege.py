...
rcp45=gpd.read_file(projectspace+"/NW"+"/NW_rcp45_zukuenftigestandorte.gpkg", layer="NW_rcp45_zukuenftigestandorte", driver="GPKG")
rcp85=gpd.read_file(projectspace+"/NW"+"/NW_rcp85_zukuenftigestandorte.gpkg", layer="NW_rcp85_zukuenftigestandorte", driver="GPKG")
rcp45.columns
...
combi.to_file(projectspace+"/NW"+"/NW_Projektionswege_combi.gpkg", layer="NW_Projektionswege_combi", driver="GPKG")
...
combi_unique.to_excel(projectspace+'/NW/'+"/NW_Projektionspfade_unique.xlsx")
...
areastatistics.to_excel(projectspace+'/NW/'+"/NW_Projektionspfade_unique_area.xlsx")
...
rcp45unique.to_excel(projectspace+'/NW/'+"/NW_Projektionspfade_unique_RCP45.xlsx")
...
areastatistics_rcp45.to_excel(projectspace+'/NW/'+"/NW_Projektionspfade_unique_area_RCP45.xlsx")
...
rcp85unique.to_excel(projectspace+'/NW/'+"/NW_Projektionspfade_unique_RCP85.xlsx")
...
areastatistics_rcp85.to_excel(projectspace+'/NW/'+"/NW_Projektionspfade_unique_area_RCP85.xlsx")
print('all done')

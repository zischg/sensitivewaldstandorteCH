...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/SH"+"/SH_rcp45_baumartenempfehlungen.gpkg", layer="SH_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/SH"+"/SH_rcp45_baumartenbedeutungen.gpkg", layer="SH_rcp45_baumartenbedeutungen", driver="GPKG")
baumartenbedeutungenrcp85=gpd.read_file(projectspace+"/SH"+"/SH_rcp85_baumartenbedeutungen.gpkg", layer="SH_rcp85_baumartenbedeutungen", driver="GPKG")
...
combi.to_file(projectspace+"/SH"+"/SH_baumartenempfehlungen_combi.gpkg", layer="SH_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

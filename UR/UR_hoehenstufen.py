...
#read excel files
naiseinheitenunique=pd.read_excel(codespace+"/UR_nais_einheiten_unique_v2_mf.xlsx", sheet_name='Sheet1', dtype="str", engine='openpyxl')
naiseinheitenunique.columns
naiseinheitenunique.dtypes
len(naiseinheitenunique)
naiseinheitenunique=naiseinheitenunique[['Kategorie_', 'Einheit_Na', 'Bedingung Region', 'Bedingung Höhenstufe', 'nais1', 'nais2', 'hs']]
...
referenceraster=myworkspace+"/UR/UR_dem10m.tif"
...
sloperaster=myworkspace+"/UR/UR_slopeprz.tif"
radiationraster=myworkspace+"/UR/UR_globradyyw.tif"
hoehenstufenraster=myworkspace+"/UR/UR_vegetationshoehenstufen1975.tif"


#read shapefile
stok_gdf=gpd.read_file(myworkspace+'/UR/Waldstandortkarte_20250204.shp')
...
winsound.Beep(frequency, duration)
stok_gdf.columns
stok_gdf.to_file(myworkspace+"/UR/stok_gdf_attributed_temp.gpkg")
#stok_gdf=gpd.read_file(myworkspace+"/UR/stok_gdf_attributed_temp.gpkg")
...
fehlendeuebersetzungen.to_excel(myworkspace+'/UR/'+'fehlendeHoehenstufen.xlsx')
...
stok_gdf.to_file(myworkspace+"/UR/stok_gdf_attributed.gpkg",layer='stok_gdf_attributed', driver="GPKG")
print("done")
...
treeapp.to_file(myworkspace+"/UR/UR_treeapp.gpkg", layer='UR_treeapp', driver="GPKG")
treeapp.columns
print("done")

...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/TG"+"/TG_rcp45_baumartenempfehlungen.gpkg", layer="TG_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/TG"+"/TG_rcp45_baumartenbedeutungen.gpkg", layer="TG_rcp45_baumartenbedeutungen", driver="GPKG")
baumartenbedeutungenrcp85=gpd.read_file(projectspace+"/TG"+"/TG_rcp85_baumartenbedeutungen.gpkg", layer="TG_rcp85_baumartenbedeutungen", driver="GPKG")
...
combi.to_file(projectspace+"/TG"+"/TG_baumartenempfehlungen_combi.gpkg", layer="TG_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

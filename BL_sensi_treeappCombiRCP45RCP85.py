...
baumartenempfehlungenrcp45=gpd.read_file(projectspace+"/BLBS"+"/BLBS_rcp45_baumartenempfehlungen.gpkg", layer="BLBS_rcp45_baumartenempfehlungen", driver="GPKG")
baumartenbedeutungenrcp45=gpd.read_file(projectspace+"/BLBS"+"/BLBS_rcp45_baumartenbedeutungen.gpkg", layer="BLBS_rcp45_baumartenbedeutungen", driver="GPKG")
baumartenbedeutungenrcp85=gpd.read_file(projectspace+"/BLBS"+"/BLBS_rcp85_baumartenbedeutungen.gpkg", layer="BLBS_rcp85_baumartenbedeutungen", driver="GPKG")
...
combi.to_file(projectspace+"/BLBS"+"/BLBS_baumartenempfehlungen_combi.gpkg", layer="BLBS_baumartenempfehlungen_combi", driver="GPKG")
print('all done')

...
#Input Shape
print('read the forest types polygon data')
stok_gdf=gpd.read_file(projectspace+"/GL/GL_treeapp_mf_korrektur2.gpkg", layer='GL_treeapp_mf_korrektur2')
stok_gdf.crs
...
referenceraster=projectspace+"/GL/dem10m.tif"
...
#indatatypeint=gdal.Open(projectspace+"/regionen.tif").GetRasterBand(1).DataType
#dhmarr=convert_tif_to_array("D:/CCW20/GIS/dhm25.tif")
NODATA_value=-9999

sloperaster=projectspace+"/GL/slope10mprz.tif"
radiationraster=projectspace+"/GL/globradyw.tif"
#hoehenstufenraster=projectspace+"/GL/hs1975.tif"
#hsheute=gpd.read_file(projectspace+"/GL/vegetationshoehenstufen19611990clipSGAIAR.shp")
...
print('preprocessing NaiS table')
...
#*******************************************
print('preprocessing Projektionswege')
...
#Standortregionen
print('attribute Standortregion')
#storeg.crs
#storeg.columns
##taheute.plot()
...
#Lage
stok_gdf['lage']=3
stok_gdf.loc[stok_gdf['meanslopeprc']<10, 'lage']=1

stok_gdf.to_file(projectspace + "/GL/" + "GL_stok_gdf_attributed_temp.gpkg")
#stok_gdf=gpd.read_file(projectspace + "/GL/" + "GL_stok_gdf_attributed_temp.gpkg")
len(stok_gdf)
#*****************************************************************
#tree-app simulation
#*****************************************************************
...
for climatescenario in climatescenarios:
    ...
    combinations_df=stok_gdf.overlay(ccgdf, how='intersection')
    #combinations_df = stok_gdf.overlay(ccgdf, how='union')
    ...
    combinations_df = combinations_df[['wg_haupt', 'wg_zusatz', 'wg_name', 'nais', 'nais1', 'nais2', 'mo', 'ue', 'taheute', 'storeg', 'tahs', 'tahsue','meanslopeprc', 'slpprzrec', 'lage', 'rad', 'radiation', 'HS_de', 'Code', 'Subcode', 'geometry']]
    combinations_df.columns
    ...
    #correct GL
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) &(combinations_df['nais1']=="24")&(combinations_df["tahs"]=="subalpin")&(combinations_df["hszukcor"]=="obermontan")), "naiszuk1"]="24"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) &(combinations_df['nais1'] == "24") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "25"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) &(combinations_df['nais1'] == "13h") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "13a"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) &(combinations_df['nais1'] == "24") & (combinations_df["tahs"] == "subalpin") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "25"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) &(combinations_df['nais1'] == "32V") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "28"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais1'] == "8d") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "6"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais1'] == "18w") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "17"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais1'] == "69G") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "65"
    combinations_df.loc[((combinations_df['storeg'].isin(['J', 'M']) == True) & (combinations_df['nais1'] == "69G") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "38"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b']) == True) & (combinations_df['nais1'] == "69G") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "40*"

    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) &(combinations_df['nais1'] == "51") & (combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk1"] = "18"
    #ue
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) &(combinations_df['nais2'] == "22") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "obermontan")), "naiszuk2"] = "22"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) &(combinations_df['nais2'] == "22") & (combinations_df["tahsue"] == "hochmontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "22"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "21") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "hochmontan")), "naiszuk2"] = "21"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "21") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "obermontan")), "naiszuk2"] = "20"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "21") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "8S"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "21") & (combinations_df["tahsue"] == "subalpin") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "7S"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "26") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "26"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "67G") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "65"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', '2a', '2b','3']) == True) & (combinations_df['nais2'] == "67G") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "40*"
    ...
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "50") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "untermontan")), "naiszuk2"] = "8S"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "50") & (combinations_df["tahsue"] == "obermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "8S"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', '2a', '2b', 'J']) == True) & (combinations_df['nais2'] == "50") & (combinations_df["tahsue"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk2"] = "8S"
    ...
    combinations_df.loc[(
            ...
            combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan") & (
                        climatescenario == 'rcp45')), "naiszuk1"] = "26"
    combinations_df.loc[(
            (combinations_df['storeg'].isin([1, '1', 'M']) == True) & (combinations_df['nais'] == "26(12a)") & (
            combinations_df["tahs"] == "obermontan") & (combinations_df["hszukcor"] == "submontan") & (

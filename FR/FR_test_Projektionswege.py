...
rcp45=gpd.read_file(projectspace+"/FR"+"/FR_rcp45_zukuenftigestandorte.gpkg", layer="FR_rcp45_zukuenftigestandorte", driver="GPKG")
rcp85=gpd.read_file(projectspace+"/FR"+"/FR_rcp85_zukuenftigestandorte.gpkg", layer="FR_rcp85_zukuenftigestandorte", driver="GPKG")
rcp45.columns
...
combi.to_file(projectspace+"/FR"+"/FR_Projektionswege_combi.gpkg", layer="FR_Projektionswege_combi", driver="GPKG")

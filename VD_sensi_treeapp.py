...
treeapp=gpd.read_file(projectspace+"/VD/stok_gdf_attributed.gpkg", layer='stok_gdf_attributed')
treeapp.columns
treeapp=treeapp[['joinid', 'VD Einheit', 'taheute', 'storeg','meanslopeprc', 'slpprzrec', 'rad', 'radiation', 'hs1975', 'nais','nais1', 'nais2', 'mo', 'ue', 'tahs', 'tahsue', 'geometry']]
...
for col in naismatrixdf.columns[8:].tolist():
    ...
    id+=1
joblib.dump(nais_matrix_standorte_list,projectspace+"/VD/"+"nais_matrix_standorte_list.sav")
...
for climatescenario in climatescenarios:
    ...
    ccgdf=gpd.read_file(projectspace+"/VD/VD_vegetationshoehenstufen_"+climatescenario+'fixed'+".gpkg", layer='VD_vegetationshoehenstufen_'+climatescenario+'fixed')
    #ccgdf.crs
    #len(ccgdf)
    print("Overlay ...")
    combinations_df=treeapp.overlay(ccgdf, how='intersection')
    #combinations_df = gpd.read_file(projectspace+"/VD/stok_gdf_attributed_"+climatescenario+".gpkg", layer='stok_gdf_attributed_'+climatescenario)
    ...
    combinations_df.rename(columns={'VD_Einheit': 'VD Einheit'}, inplace=True)
    print("Overlay done...")
    ...
    len(combinations_df)
    combinations_df.columns
    combinations_df=combinations_df[['VD Einheit', 'nais','nais1', 'nais2', 'mo', 'ue','hs1975','taheute','storeg', 'tahs','tahsue', 'meanslopeprc', 'slpprzrec', 'lage','rad', 'radiation', 'HS_de', 'Code', 'Subcode','geometry']]
    combinations_df.columns
    ...
    joblib.dump(combinations_df, projectspace+"/VD/combinations_df"+climatescenario+".sav")
    combinations_df.columns
    ...
    combinations_df.loc[((combinations_df['storeg'].isin(['M', 'J']) == True) & (combinations_df['nais1'] == "16") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "39"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais1'] == "16") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "40*"
    combinations_df.loc[((combinations_df['storeg'].isin(['M', 'J']) == True) & (combinations_df['nais1'] == "16") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "39 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3']) == True) & (combinations_df['nais1'] == "16") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "40* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'J', 'M']) == True) & (combinations_df['nais1'] == "24*") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "25F"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3','J','M']) == True) & (combinations_df['nais1'] == "24*") & (combinations_df["tahs"] == "hochmontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "24* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'J', 'M']) == True) & (combinations_df['nais1'] == "25e") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "submontan")), "naiszuk1"] = "25e"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'J', 'M']) == True) & (combinations_df['nais1'] == "34*") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'J', 'M']) == True) & (combinations_df['nais1'] == "34*") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "34* collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'J', 'M']) == True) & (combinations_df['nais1'] == "65") & (combinations_df["tahs"] == "untermontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "38 collin"
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', 'J', 'M']) == True) & (combinations_df['nais1'] == "66L") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "66L collin"
    ...
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 'M', 'J', '2a']) == True) & (combinations_df['nais1'] == "68") & (combinations_df["tahs"] == "submontan") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = "41* collin"
    ...
    # nais1
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'J', 'M']) == True) & (combinations_df['nais1'] == "26") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '26 collin'
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'J', 'M']) == True) & (combinations_df['nais1'] == "27f") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '27f collin'
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'J', 'M']) == True) & (combinations_df['nais1'] == "29") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '29 collin'
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'J', 'M']) == True) & (combinations_df['nais1'] == "39") & (combinations_df["tahs"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk1"] = '39 collin'
    ...
    # nais2
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'J', 'M']) == True) & (combinations_df['nais2'] == "26") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = '26 collin'
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'J', 'M']) == True) & (combinations_df['nais1'] == "27f") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = '27f collin'
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'J', 'M']) == True) & (combinations_df['nais1'] == "29") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = '29 collin'
    combinations_df.loc[((combinations_df['storeg'].isin([1, '1', 2, '2', '2a', '2b', '3', 'J', 'M']) == True) & (combinations_df['nais2'] == "39") & (combinations_df["tahsue"] == "collin") & (combinations_df["hszukcor"] == "collin")), "naiszuk2"] = '39 collin'
    ...
    # listofnopathcombinations
    nopathoutfile = open(projectspace + "/VD/" + climatescenario.lower() + "_listofnopathcombinations.txt", "w")
    ...
    for item in listofnopathcombinations2:
        nopathoutfile.write(str(item[0]) + ";" + str(item[1]) + ";" + str(item[2]) + ";" + str(item[3]) + "\n")
    nopathoutfile.close()
    joblib.dump(combinations_df, projectspace + "/VD" + "VD_" + climatescenario + "_combinations_df_futureSTO.sav")
    combinations_df.to_file(projectspace + "/VD/" + "VD_" + climatescenario + "_zukuenftigestandorte.gpkg")
    ...
    joblib.dump(gr_treetypes_LFI, projectspace + "/VD/" + "treetypes_LFI.sav")

    naismatrix_gr_df = naismatrixdf[naismatrixdf["Abkuerzung"].isin(gr_treetypes_LFI)]
    len(naismatrix_gr_df)
    joblib.dump(naismatrix_gr_df, projectspace + "/VD/" + "naismatrix_gr_df.sav")
    ...
    joblib.dump(combinations_df_bedeutung,
                projectspace + "/VD" + "/VD_" + climatescenario.lower() + "_combinations_df_baumartenbedeutungen.sav")
    ...
    combinations_df_bedeutung.to_file(projectspace + "/VD" + "/VD_" + climatescenario + "_baumartenbedeutungen.gpkg",
                                      layer="VD_" + climatescenario + "_baumartenbedeutungen", driver="GPKG")
    ...
    #combinations_df_bedeutung = joblib.load(projectspace + "/VD" + "/VD_" + climatescenario.lower() + "_combinations_df_baumartenbedeutungen.sav")
        ...
        combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["ue"] == 1) & (
            combinations_df_baumartenempfehlung[col + "zukUE"].isin(["c"])) & (
                                                     ~combinations_df_baumartenempfehlung[col + "heuUE"].isin(
                                                         ["a", "b", "c"]))), col] = 5
    # Arve
    combinations_df_baumartenempfehlung.loc[((combinations_df_baumartenempfehlung["nais1"].isin(arvenundlaerchen)) & (combinations_df_baumartenempfehlung["tahs"] == 'obersubalpin') & (combinations_df_baumartenempfehlung["hszukcor"] == 'hochmontan')), 'VD_'] = 6
    ...
    joblib.dump(combinations_df_baumartenempfehlung,
                projectspace + "/VD" + "/VD_" + climatescenario.lower() + "_baumartenempfehlungen.sav")
    combinations_df_baumartenempfehlung.to_file(
        projectspace + "/VD" + "/VD_" + climatescenario + "_baumartenempfehlungen.gpkg",
        layer="VD_" + climatescenario + "_baumartenempfehlungen", driver="GPKG")
    ...
    joblib.dump(combinations_df_senstivestandorte,
                projectspace + "/VD" + "/VD_" + climatescenario.lower() + "_sensitivestandorte.sav")
    combinations_df_senstivestandorte.to_file(
        projectspace + "/VD" + "/VD_" + climatescenario + "_sensitivestandorte.gpkg",
        layer="VD_" + climatescenario + "_sensitivestandorte", driver="GPKG")
